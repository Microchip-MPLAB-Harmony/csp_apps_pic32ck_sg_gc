...
/*  file generated from device description file (ATDF) version 2026-09-01T07:31:03Z  */
...
#define MCRAMC_CTRLA_SWRST(value)             (MCRAMC_CTRLA_SWRST_Msk & ((uint32_t)(value) << MCRAMC_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the MCRAMC_CTRLA register */
...
#define MCRAMC_CTRLA_ENABLE(value)            (MCRAMC_CTRLA_ENABLE_Msk & ((uint32_t)(value) << MCRAMC_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the MCRAMC_CTRLA register */
...
#define MCRAMC_INTENCLR_SERREN(value)         (MCRAMC_INTENCLR_SERREN_Msk & ((uint32_t)(value) << MCRAMC_INTENCLR_SERREN_Pos)) /* Assignment of value for SERREN in the MCRAMC_INTENCLR register */
...
#define MCRAMC_INTENCLR_DERREN(value)         (MCRAMC_INTENCLR_DERREN_Msk & ((uint32_t)(value) << MCRAMC_INTENCLR_DERREN_Pos)) /* Assignment of value for DERREN in the MCRAMC_INTENCLR register */
...
#define MCRAMC_INTENSET_SERREN(value)         (MCRAMC_INTENSET_SERREN_Msk & ((uint32_t)(value) << MCRAMC_INTENSET_SERREN_Pos)) /* Assignment of value for SERREN in the MCRAMC_INTENSET register */
...
#define MCRAMC_INTENSET_DERREN(value)         (MCRAMC_INTENSET_DERREN_Msk & ((uint32_t)(value) << MCRAMC_INTENSET_DERREN_Pos)) /* Assignment of value for DERREN in the MCRAMC_INTENSET register */
...
#define MCRAMC_INTSTA_SERR(value)             (MCRAMC_INTSTA_SERR_Msk & ((uint32_t)(value) << MCRAMC_INTSTA_SERR_Pos)) /* Assignment of value for SERR in the MCRAMC_INTSTA register */
...
#define MCRAMC_INTSTA_DERR(value)             (MCRAMC_INTSTA_DERR_Msk & ((uint32_t)(value) << MCRAMC_INTSTA_DERR_Pos)) /* Assignment of value for DERR in the MCRAMC_INTSTA register */
...
#define MCRAMC_FLTCTRL_FLTEN(value)           (MCRAMC_FLTCTRL_FLTEN_Msk & ((uint32_t)(value) << MCRAMC_FLTCTRL_FLTEN_Pos)) /* Assignment of value for FLTEN in the MCRAMC_FLTCTRL register */
...
#define MCRAMC_FLTCTRL_FLTMD(value)           (MCRAMC_FLTCTRL_FLTMD_Msk & ((uint32_t)(value) << MCRAMC_FLTCTRL_FLTMD_Pos)) /* Assignment of value for FLTMD in the MCRAMC_FLTCTRL register */
...
#define MCRAMC_FLTPTR_FLT1PTR(value)          (MCRAMC_FLTPTR_FLT1PTR_Msk & ((uint32_t)(value) << MCRAMC_FLTPTR_FLT1PTR_Pos)) /* Assignment of value for FLT1PTR in the MCRAMC_FLTPTR register */
...
#define MCRAMC_FLTPTR_FLT2PTR(value)          (MCRAMC_FLTPTR_FLT2PTR_Msk & ((uint32_t)(value) << MCRAMC_FLTPTR_FLT2PTR_Pos)) /* Assignment of value for FLT2PTR in the MCRAMC_FLTPTR register */
...
#define MCRAMC_FLTADR_FLTADR(value)           (MCRAMC_FLTADR_FLTADR_Msk & ((uint32_t)(value) << MCRAMC_FLTADR_FLTADR_Pos)) /* Assignment of value for FLTADR in the MCRAMC_FLTADR register */
...
#define MCRAMC_ERRCADR_ERCADR(value)          (MCRAMC_ERRCADR_ERCADR_Msk & ((uint32_t)(value) << MCRAMC_ERRCADR_ERCADR_Pos)) /* Assignment of value for ERCADR in the MCRAMC_ERRCADR register */
...
#define MCRAMC_ERRCPAR_ERCPAR(value)          (MCRAMC_ERRCPAR_ERCPAR_Msk & ((uint32_t)(value) << MCRAMC_ERRCPAR_ERCPAR_Pos)) /* Assignment of value for ERCPAR in the MCRAMC_ERRCPAR register */
...
#define MCRAMC_ERRCSYN_ERCSYN(value)          (MCRAMC_ERRCSYN_ERCSYN_Msk & ((uint32_t)(value) << MCRAMC_ERRCSYN_ERCSYN_Pos)) /* Assignment of value for ERCSYN in the MCRAMC_ERRCSYN register */
...
#define MCRAMC_ERRCSYN_ERR1(value)            (MCRAMC_ERRCSYN_ERR1_Msk & ((uint32_t)(value) << MCRAMC_ERRCSYN_ERR1_Pos)) /* Assignment of value for ERR1 in the MCRAMC_ERRCSYN register */
...
#define MCRAMC_ERRCSYN_ERR2(value)            (MCRAMC_ERRCSYN_ERR2_Msk & ((uint32_t)(value) << MCRAMC_ERRCSYN_ERR2_Pos)) /* Assignment of value for ERR2 in the MCRAMC_ERRCSYN register */
...
#define MCRAMC_ERRCSYN_ERR(value)             (MCRAMC_ERRCSYN_ERR_Msk & ((uint32_t)(value) << MCRAMC_ERRCSYN_ERR_Pos)) 
