...
#define EVSYS_CHANNEL_EVGEN(value)            (EVSYS_CHANNEL_EVGEN_Msk & ((uint32_t)(value) << EVSYS_CHANNEL_EVGEN_Pos)) /* Assignment of value for EVGEN in the EVSYS_CHANNEL register */
...
#define EVSYS_CHANNEL_PATH(value)             (EVSYS_CHANNEL_PATH_Msk & ((uint32_t)(value) << EVSYS_CHANNEL_PATH_Pos)) /* Assignment of value for PATH in the EVSYS_CHANNEL register */
...
#define EVSYS_CHANNEL_EDGSEL(value)           (EVSYS_CHANNEL_EDGSEL_Msk & ((uint32_t)(value) << EVSYS_CHANNEL_EDGSEL_Pos)) /* Assignment of value for EDGSEL in the EVSYS_CHANNEL register */
...
#define EVSYS_CHANNEL_RUNSTDBY(value)         (EVSYS_CHANNEL_RUNSTDBY_Msk & ((uint32_t)(value) << EVSYS_CHANNEL_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the EVSYS_CHANNEL register */
...
#define EVSYS_CHANNEL_ONDEMAND(value)         (EVSYS_CHANNEL_ONDEMAND_Msk & ((uint32_t)(value) << EVSYS_CHANNEL_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the EVSYS_CHANNEL register */
...
#define EVSYS_CHINTENCLR_OVR(value)           (EVSYS_CHINTENCLR_OVR_Msk & ((uint8_t)(value) << EVSYS_CHINTENCLR_OVR_Pos)) /* Assignment of value for OVR in the EVSYS_CHINTENCLR register */
...
#define EVSYS_CHINTENCLR_EVD(value)           (EVSYS_CHINTENCLR_EVD_Msk & ((uint8_t)(value) << EVSYS_CHINTENCLR_EVD_Pos)) /* Assignment of value for EVD in the EVSYS_CHINTENCLR register */
...
#define EVSYS_CHINTENSET_OVR(value)           (EVSYS_CHINTENSET_OVR_Msk & ((uint8_t)(value) << EVSYS_CHINTENSET_OVR_Pos)) /* Assignment of value for OVR in the EVSYS_CHINTENSET register */
...
#define EVSYS_CHINTENSET_EVD(value)           (EVSYS_CHINTENSET_EVD_Msk & ((uint8_t)(value) << EVSYS_CHINTENSET_EVD_Pos)) /* Assignment of value for EVD in the EVSYS_CHINTENSET register */
...
#define EVSYS_CHINTFLAG_OVR(value)            (EVSYS_CHINTFLAG_OVR_Msk & ((uint8_t)(value) << EVSYS_CHINTFLAG_OVR_Pos)) /* Assignment of value for OVR in the EVSYS_CHINTFLAG register */
...
#define EVSYS_CHINTFLAG_EVD(value)            (EVSYS_CHINTFLAG_EVD_Msk & ((uint8_t)(value) << EVSYS_CHINTFLAG_EVD_Pos)) /* Assignment of value for EVD in the EVSYS_CHINTFLAG register */
...
#define EVSYS_CHSTATUS_RDYUSR(value)          (EVSYS_CHSTATUS_RDYUSR_Msk & ((uint8_t)(value) << EVSYS_CHSTATUS_RDYUSR_Pos)) /* Assignment of value for RDYUSR in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_BUSYCH(value)          (EVSYS_CHSTATUS_BUSYCH_Msk & ((uint8_t)(value) << EVSYS_CHSTATUS_BUSYCH_Pos)) /* Assignment of value for BUSYCH in the EVSYS_CHSTATUS register */
...
#define EVSYS_CTRLA_SWRST(value)              (EVSYS_CTRLA_SWRST_Msk & ((uint8_t)(value) << EVSYS_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the EVSYS_CTRLA register */
...
#define EVSYS_SWEVT_CHANNEL0(value)           (EVSYS_SWEVT_CHANNEL0_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL0_Pos)) /* Assignment of value for CHANNEL0 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL1(value)           (EVSYS_SWEVT_CHANNEL1_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL1_Pos)) /* Assignment of value for CHANNEL1 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL2(value)           (EVSYS_SWEVT_CHANNEL2_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL2_Pos)) /* Assignment of value for CHANNEL2 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL3(value)           (EVSYS_SWEVT_CHANNEL3_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL3_Pos)) /* Assignment of value for CHANNEL3 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL4(value)           (EVSYS_SWEVT_CHANNEL4_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL4_Pos)) /* Assignment of value for CHANNEL4 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL5(value)           (EVSYS_SWEVT_CHANNEL5_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL5_Pos)) /* Assignment of value for CHANNEL5 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL6(value)           (EVSYS_SWEVT_CHANNEL6_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL6_Pos)) /* Assignment of value for CHANNEL6 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL7(value)           (EVSYS_SWEVT_CHANNEL7_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL7_Pos)) /* Assignment of value for CHANNEL7 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL8(value)           (EVSYS_SWEVT_CHANNEL8_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL8_Pos)) /* Assignment of value for CHANNEL8 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL9(value)           (EVSYS_SWEVT_CHANNEL9_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL9_Pos)) /* Assignment of value for CHANNEL9 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL10(value)          (EVSYS_SWEVT_CHANNEL10_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL10_Pos)) /* Assignment of value for CHANNEL10 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL11(value)          (EVSYS_SWEVT_CHANNEL11_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL11_Pos)) /* Assignment of value for CHANNEL11 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL12(value)          (EVSYS_SWEVT_CHANNEL12_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL12_Pos)) /* Assignment of value for CHANNEL12 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL13(value)          (EVSYS_SWEVT_CHANNEL13_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL13_Pos)) /* Assignment of value for CHANNEL13 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL14(value)          (EVSYS_SWEVT_CHANNEL14_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL14_Pos)) /* Assignment of value for CHANNEL14 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL15(value)          (EVSYS_SWEVT_CHANNEL15_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL15_Pos)) /* Assignment of value for CHANNEL15 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL16(value)          (EVSYS_SWEVT_CHANNEL16_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL16_Pos)) /* Assignment of value for CHANNEL16 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL17(value)          (EVSYS_SWEVT_CHANNEL17_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL17_Pos)) /* Assignment of value for CHANNEL17 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL18(value)          (EVSYS_SWEVT_CHANNEL18_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL18_Pos)) /* Assignment of value for CHANNEL18 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL19(value)          (EVSYS_SWEVT_CHANNEL19_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL19_Pos)) /* Assignment of value for CHANNEL19 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL20(value)          (EVSYS_SWEVT_CHANNEL20_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL20_Pos)) /* Assignment of value for CHANNEL20 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL21(value)          (EVSYS_SWEVT_CHANNEL21_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL21_Pos)) /* Assignment of value for CHANNEL21 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL22(value)          (EVSYS_SWEVT_CHANNEL22_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL22_Pos)) /* Assignment of value for CHANNEL22 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL23(value)          (EVSYS_SWEVT_CHANNEL23_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL23_Pos)) /* Assignment of value for CHANNEL23 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL24(value)          (EVSYS_SWEVT_CHANNEL24_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL24_Pos)) /* Assignment of value for CHANNEL24 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL25(value)          (EVSYS_SWEVT_CHANNEL25_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL25_Pos)) /* Assignment of value for CHANNEL25 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL26(value)          (EVSYS_SWEVT_CHANNEL26_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL26_Pos)) /* Assignment of value for CHANNEL26 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL27(value)          (EVSYS_SWEVT_CHANNEL27_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL27_Pos)) /* Assignment of value for CHANNEL27 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL28(value)          (EVSYS_SWEVT_CHANNEL28_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL28_Pos)) /* Assignment of value for CHANNEL28 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL29(value)          (EVSYS_SWEVT_CHANNEL29_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL29_Pos)) /* Assignment of value for CHANNEL29 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL30(value)          (EVSYS_SWEVT_CHANNEL30_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL30_Pos)) /* Assignment of value for CHANNEL30 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL31(value)          (EVSYS_SWEVT_CHANNEL31_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL31_Pos)) /* Assignment of value for CHANNEL31 in the EVSYS_SWEVT register */
...
#define EVSYS_SWEVT_CHANNEL(value)            (EVSYS_SWEVT_CHANNEL_Msk & ((uint32_t)(value) << EVSYS_SWEVT_CHANNEL_Pos)) 
...
#define EVSYS_PRICTRL_PRI(value)              (EVSYS_PRICTRL_PRI_Msk & ((uint8_t)(value) << EVSYS_PRICTRL_PRI_Pos)) /* Assignment of value for PRI in the EVSYS_PRICTRL register */
...
#define EVSYS_PRICTRL_RREN(value)             (EVSYS_PRICTRL_RREN_Msk & ((uint8_t)(value) << EVSYS_PRICTRL_RREN_Pos)) /* Assignment of value for RREN in the EVSYS_PRICTRL register */
...
#define EVSYS_INTPEND_ID(value)               (EVSYS_INTPEND_ID_Msk & ((uint16_t)(value) << EVSYS_INTPEND_ID_Pos)) /* Assignment of value for ID in the EVSYS_INTPEND register */
...
#define EVSYS_INTPEND_OVR(value)              (EVSYS_INTPEND_OVR_Msk & ((uint16_t)(value) << EVSYS_INTPEND_OVR_Pos)) /* Assignment of value for OVR in the EVSYS_INTPEND register */
...
#define EVSYS_INTPEND_EVD(value)              (EVSYS_INTPEND_EVD_Msk & ((uint16_t)(value) << EVSYS_INTPEND_EVD_Pos)) /* Assignment of value for EVD in the EVSYS_INTPEND register */
...
#define EVSYS_INTPEND_READY(value)            (EVSYS_INTPEND_READY_Msk & ((uint16_t)(value) << EVSYS_INTPEND_READY_Pos)) /* Assignment of value for READY in the EVSYS_INTPEND register */
...
#define EVSYS_INTPEND_BUSY(value)             (EVSYS_INTPEND_BUSY_Msk & ((uint16_t)(value) << EVSYS_INTPEND_BUSY_Pos)) /* Assignment of value for BUSY in the EVSYS_INTPEND register */
...
#define EVSYS_INTSTATUS_CHINT0(value)         (EVSYS_INTSTATUS_CHINT0_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT0_Pos)) /* Assignment of value for CHINT0 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT1(value)         (EVSYS_INTSTATUS_CHINT1_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT1_Pos)) /* Assignment of value for CHINT1 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT2(value)         (EVSYS_INTSTATUS_CHINT2_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT2_Pos)) /* Assignment of value for CHINT2 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT3(value)         (EVSYS_INTSTATUS_CHINT3_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT3_Pos)) /* Assignment of value for CHINT3 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT4(value)         (EVSYS_INTSTATUS_CHINT4_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT4_Pos)) /* Assignment of value for CHINT4 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT5(value)         (EVSYS_INTSTATUS_CHINT5_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT5_Pos)) /* Assignment of value for CHINT5 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT6(value)         (EVSYS_INTSTATUS_CHINT6_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT6_Pos)) /* Assignment of value for CHINT6 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT7(value)         (EVSYS_INTSTATUS_CHINT7_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT7_Pos)) /* Assignment of value for CHINT7 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT8(value)         (EVSYS_INTSTATUS_CHINT8_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT8_Pos)) /* Assignment of value for CHINT8 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT9(value)         (EVSYS_INTSTATUS_CHINT9_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT9_Pos)) /* Assignment of value for CHINT9 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT10(value)        (EVSYS_INTSTATUS_CHINT10_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT10_Pos)) /* Assignment of value for CHINT10 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT11(value)        (EVSYS_INTSTATUS_CHINT11_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT11_Pos)) /* Assignment of value for CHINT11 in the EVSYS_INTSTATUS register */
...
#define EVSYS_INTSTATUS_CHINT(value)          (EVSYS_INTSTATUS_CHINT_Msk & ((uint32_t)(value) << EVSYS_INTSTATUS_CHINT_Pos)) 
...
#define EVSYS_BUSYCH_BUSYCH0(value)           (EVSYS_BUSYCH_BUSYCH0_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH0_Pos)) /* Assignment of value for BUSYCH0 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH1(value)           (EVSYS_BUSYCH_BUSYCH1_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH1_Pos)) /* Assignment of value for BUSYCH1 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH2(value)           (EVSYS_BUSYCH_BUSYCH2_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH2_Pos)) /* Assignment of value for BUSYCH2 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH3(value)           (EVSYS_BUSYCH_BUSYCH3_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH3_Pos)) /* Assignment of value for BUSYCH3 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH4(value)           (EVSYS_BUSYCH_BUSYCH4_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH4_Pos)) /* Assignment of value for BUSYCH4 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH5(value)           (EVSYS_BUSYCH_BUSYCH5_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH5_Pos)) /* Assignment of value for BUSYCH5 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH6(value)           (EVSYS_BUSYCH_BUSYCH6_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH6_Pos)) /* Assignment of value for BUSYCH6 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH7(value)           (EVSYS_BUSYCH_BUSYCH7_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH7_Pos)) /* Assignment of value for BUSYCH7 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH8(value)           (EVSYS_BUSYCH_BUSYCH8_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH8_Pos)) /* Assignment of value for BUSYCH8 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH9(value)           (EVSYS_BUSYCH_BUSYCH9_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH9_Pos)) /* Assignment of value for BUSYCH9 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH10(value)          (EVSYS_BUSYCH_BUSYCH10_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH10_Pos)) /* Assignment of value for BUSYCH10 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH11(value)          (EVSYS_BUSYCH_BUSYCH11_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH11_Pos)) /* Assignment of value for BUSYCH11 in the EVSYS_BUSYCH register */
...
#define EVSYS_BUSYCH_BUSYCH(value)            (EVSYS_BUSYCH_BUSYCH_Msk & ((uint32_t)(value) << EVSYS_BUSYCH_BUSYCH_Pos)) 
...
#define EVSYS_READYUSR_READYUSR0(value)       (EVSYS_READYUSR_READYUSR0_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR0_Pos)) /* Assignment of value for READYUSR0 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR1(value)       (EVSYS_READYUSR_READYUSR1_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR1_Pos)) /* Assignment of value for READYUSR1 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR2(value)       (EVSYS_READYUSR_READYUSR2_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR2_Pos)) /* Assignment of value for READYUSR2 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR3(value)       (EVSYS_READYUSR_READYUSR3_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR3_Pos)) /* Assignment of value for READYUSR3 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR4(value)       (EVSYS_READYUSR_READYUSR4_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR4_Pos)) /* Assignment of value for READYUSR4 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR5(value)       (EVSYS_READYUSR_READYUSR5_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR5_Pos)) /* Assignment of value for READYUSR5 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR6(value)       (EVSYS_READYUSR_READYUSR6_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR6_Pos)) /* Assignment of value for READYUSR6 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR7(value)       (EVSYS_READYUSR_READYUSR7_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR7_Pos)) /* Assignment of value for READYUSR7 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR8(value)       (EVSYS_READYUSR_READYUSR8_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR8_Pos)) /* Assignment of value for READYUSR8 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR9(value)       (EVSYS_READYUSR_READYUSR9_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR9_Pos)) /* Assignment of value for READYUSR9 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR10(value)      (EVSYS_READYUSR_READYUSR10_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR10_Pos)) /* Assignment of value for READYUSR10 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR11(value)      (EVSYS_READYUSR_READYUSR11_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR11_Pos)) /* Assignment of value for READYUSR11 in the EVSYS_READYUSR register */
...
#define EVSYS_READYUSR_READYUSR(value)        (EVSYS_READYUSR_READYUSR_Msk & ((uint32_t)(value) << EVSYS_READYUSR_READYUSR_Pos)) 
...
#define EVSYS_USER_CHANNEL(value)             (EVSYS_USER_CHANNEL_Msk & ((uint8_t)(value) << EVSYS_USER_CHANNEL_Pos)) /* Assignment of value for CHANNEL in the EVSYS_USER register */
