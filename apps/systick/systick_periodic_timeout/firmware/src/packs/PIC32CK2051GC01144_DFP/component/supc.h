...
#define SUPC_INTENCLR_LVDET(value)            (SUPC_INTENCLR_LVDET_Msk & ((uint32_t)(value) << SUPC_INTENCLR_LVDET_Pos)) /* Assignment of value for LVDET in the SUPC_INTENCLR register */
...
#define SUPC_INTENCLR_LVDRDY(value)           (SUPC_INTENCLR_LVDRDY_Msk & ((uint32_t)(value) << SUPC_INTENCLR_LVDRDY_Pos)) /* Assignment of value for LVDRDY in the SUPC_INTENCLR register */
...
#define SUPC_INTENCLR_BORVDDUSB(value)        (SUPC_INTENCLR_BORVDDUSB_Msk & ((uint32_t)(value) << SUPC_INTENCLR_BORVDDUSB_Pos)) /* Assignment of value for BORVDDUSB in the SUPC_INTENCLR register */
...
#define SUPC_INTENCLR_ADDVREGRDY0(value)      (SUPC_INTENCLR_ADDVREGRDY0_Msk & ((uint32_t)(value) << SUPC_INTENCLR_ADDVREGRDY0_Pos)) /* Assignment of value for ADDVREGRDY0 in the SUPC_INTENCLR register */
#define SUPC_INTENCLR_Msk                     _UINT32_(0x00000123)                                 /* (SUPC_INTENCLR) Register Mask  */
...
#define SUPC_INTENCLR_ADDVREGRDY(value)       (SUPC_INTENCLR_ADDVREGRDY_Msk & ((uint32_t)(value) << SUPC_INTENCLR_ADDVREGRDY_Pos)) 
...
#define SUPC_INTENSET_LVDET(value)            (SUPC_INTENSET_LVDET_Msk & ((uint32_t)(value) << SUPC_INTENSET_LVDET_Pos)) /* Assignment of value for LVDET in the SUPC_INTENSET register */
...
#define SUPC_INTENSET_LVDRDY(value)           (SUPC_INTENSET_LVDRDY_Msk & ((uint32_t)(value) << SUPC_INTENSET_LVDRDY_Pos)) /* Assignment of value for LVDRDY in the SUPC_INTENSET register */
...
#define SUPC_INTENSET_BORVDDUSB(value)        (SUPC_INTENSET_BORVDDUSB_Msk & ((uint32_t)(value) << SUPC_INTENSET_BORVDDUSB_Pos)) /* Assignment of value for BORVDDUSB in the SUPC_INTENSET register */
...
#define SUPC_INTENSET_ADDVREGRDY0(value)      (SUPC_INTENSET_ADDVREGRDY0_Msk & ((uint32_t)(value) << SUPC_INTENSET_ADDVREGRDY0_Pos)) /* Assignment of value for ADDVREGRDY0 in the SUPC_INTENSET register */
#define SUPC_INTENSET_Msk                     _UINT32_(0x00000123)                                 /* (SUPC_INTENSET) Register Mask  */
...
#define SUPC_INTENSET_ADDVREGRDY(value)       (SUPC_INTENSET_ADDVREGRDY_Msk & ((uint32_t)(value) << SUPC_INTENSET_ADDVREGRDY_Pos)) 
...
#define SUPC_INTFLAG_LVDET(value)             (SUPC_INTFLAG_LVDET_Msk & ((uint32_t)(value) << SUPC_INTFLAG_LVDET_Pos)) /* Assignment of value for LVDET in the SUPC_INTFLAG register */
...
#define SUPC_INTFLAG_LVDRDY(value)            (SUPC_INTFLAG_LVDRDY_Msk & ((uint32_t)(value) << SUPC_INTFLAG_LVDRDY_Pos)) /* Assignment of value for LVDRDY in the SUPC_INTFLAG register */
...
#define SUPC_INTFLAG_BORVDDUSB(value)         (SUPC_INTFLAG_BORVDDUSB_Msk & ((uint32_t)(value) << SUPC_INTFLAG_BORVDDUSB_Pos)) /* Assignment of value for BORVDDUSB in the SUPC_INTFLAG register */
...
#define SUPC_INTFLAG_ADDVREGRDY0(value)       (SUPC_INTFLAG_ADDVREGRDY0_Msk & ((uint32_t)(value) << SUPC_INTFLAG_ADDVREGRDY0_Pos)) /* Assignment of value for ADDVREGRDY0 in the SUPC_INTFLAG register */
#define SUPC_INTFLAG_Msk                      _UINT32_(0x00000123)                                 /* (SUPC_INTFLAG) Register Mask  */
...
#define SUPC_INTFLAG_ADDVREGRDY(value)        (SUPC_INTFLAG_ADDVREGRDY_Msk & ((uint32_t)(value) << SUPC_INTFLAG_ADDVREGRDY_Pos)) 
...
#define SUPC_STATUS_LVDET(value)              (SUPC_STATUS_LVDET_Msk & ((uint32_t)(value) << SUPC_STATUS_LVDET_Pos)) /* Assignment of value for LVDET in the SUPC_STATUS register */
...
#define SUPC_STATUS_LVDRDY(value)             (SUPC_STATUS_LVDRDY_Msk & ((uint32_t)(value) << SUPC_STATUS_LVDRDY_Pos)) /* Assignment of value for LVDRDY in the SUPC_STATUS register */
...
#define SUPC_STATUS_BORVDDUSB(value)          (SUPC_STATUS_BORVDDUSB_Msk & ((uint32_t)(value) << SUPC_STATUS_BORVDDUSB_Pos)) /* Assignment of value for BORVDDUSB in the SUPC_STATUS register */
...
#define SUPC_STATUS_ADDVREGRDY0(value)        (SUPC_STATUS_ADDVREGRDY0_Msk & ((uint32_t)(value) << SUPC_STATUS_ADDVREGRDY0_Pos)) /* Assignment of value for ADDVREGRDY0 in the SUPC_STATUS register */
#define SUPC_STATUS_Msk                       _UINT32_(0x00000123)                                 /* (SUPC_STATUS) Register Mask  */
...
#define SUPC_STATUS_ADDVREGRDY(value)         (SUPC_STATUS_ADDVREGRDY_Msk & ((uint32_t)(value) << SUPC_STATUS_ADDVREGRDY_Pos)) 
...
#define SUPC_SYNCBUSY_BOR(value)              (SUPC_SYNCBUSY_BOR_Msk & ((uint32_t)(value) << SUPC_SYNCBUSY_BOR_Pos)) /* Assignment of value for BOR in the SUPC_SYNCBUSY register */
...
#define SUPC_BOR_ACTION(value)                (SUPC_BOR_ACTION_Msk & ((uint32_t)(value) << SUPC_BOR_ACTION_Pos)) /* Assignment of value for ACTION in the SUPC_BOR register */
...
#define SUPC_BOR_DCBORPSEL(value)             (SUPC_BOR_DCBORPSEL_Msk & ((uint32_t)(value) << SUPC_BOR_DCBORPSEL_Pos)) /* Assignment of value for DCBORPSEL in the SUPC_BOR register */
...
#define SUPC_BOR_BORFILT(value)               (SUPC_BOR_BORFILT_Msk & ((uint32_t)(value) << SUPC_BOR_BORFILT_Pos)) /* Assignment of value for BORFILT in the SUPC_BOR register */
...
#define SUPC_LVD_ENABLE(value)                (SUPC_LVD_ENABLE_Msk & ((uint32_t)(value) << SUPC_LVD_ENABLE_Pos)) /* Assignment of value for ENABLE in the SUPC_LVD register */
...
#define SUPC_LVD_DIR(value)                   (SUPC_LVD_DIR_Msk & ((uint32_t)(value) << SUPC_LVD_DIR_Pos)) /* Assignment of value for DIR in the SUPC_LVD register */
...
#define SUPC_LVD_OEVEN(value)                 (SUPC_LVD_OEVEN_Msk & ((uint32_t)(value) << SUPC_LVD_OEVEN_Pos)) /* Assignment of value for OEVEN in the SUPC_LVD register */
...
#define SUPC_LVD_RUNSTDBY(value)              (SUPC_LVD_RUNSTDBY_Msk & ((uint32_t)(value) << SUPC_LVD_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the SUPC_LVD register */
...
#define SUPC_LVD_LEVEL(value)                 (SUPC_LVD_LEVEL_Msk & ((uint32_t)(value) << SUPC_LVD_LEVEL_Pos)) /* Assignment of value for LEVEL in the SUPC_LVD register */
...
#define SUPC_VREGCTRL_OFFSTDBY(value)         (SUPC_VREGCTRL_OFFSTDBY_Msk & ((uint32_t)(value) << SUPC_VREGCTRL_OFFSTDBY_Pos)) /* Assignment of value for OFFSTDBY in the SUPC_VREGCTRL register */
...
#define SUPC_VREGCTRL_LVSTDBY(value)          (SUPC_VREGCTRL_LVSTDBY_Msk & ((uint32_t)(value) << SUPC_VREGCTRL_LVSTDBY_Pos)) /* Assignment of value for LVSTDBY in the SUPC_VREGCTRL register */
...
#define SUPC_VREGCTRL_LVHIB(value)            (SUPC_VREGCTRL_LVHIB_Msk & ((uint32_t)(value) << SUPC_VREGCTRL_LVHIB_Pos)) /* Assignment of value for LVHIB in the SUPC_VREGCTRL register */
...
#define SUPC_VREGCTRL_CPEN(value)             (SUPC_VREGCTRL_CPEN_Msk & ((uint32_t)(value) << SUPC_VREGCTRL_CPEN_Pos)) /* Assignment of value for CPEN in the SUPC_VREGCTRL register */
...
#define SUPC_VREGCTRL_AVREGEN(value)          (SUPC_VREGCTRL_AVREGEN_Msk & ((uint32_t)(value) << SUPC_VREGCTRL_AVREGEN_Pos)) /* Assignment of value for AVREGEN in the SUPC_VREGCTRL register */
...
#define SUPC_VREGCTRL_AVREGSTDBY(value)       (SUPC_VREGCTRL_AVREGSTDBY_Msk & ((uint32_t)(value) << SUPC_VREGCTRL_AVREGSTDBY_Pos)) /* Assignment of value for AVREGSTDBY in the SUPC_VREGCTRL register */
...
#define SUPC_VREGCTRL_Msk                     _UINT32_(0x01010334)                                 /* (SUPC_VREGCTRL) Register Mask  */
...
#define SUPC_VREFCTRL_LPSTDBY(value)          (SUPC_VREFCTRL_LPSTDBY_Msk & ((uint32_t)(value) << SUPC_VREFCTRL_LPSTDBY_Pos)) /* Assignment of value for LPSTDBY in the SUPC_VREFCTRL register */
...
#define SUPC_VREFCTRL_LPHIB(value)            (SUPC_VREFCTRL_LPHIB_Msk & ((uint32_t)(value) << SUPC_VREFCTRL_LPHIB_Pos)) /* Assignment of value for LPHIB in the SUPC_VREFCTRL register */
...
#define SUPC_VREFCTRL_TSEN(value)             (SUPC_VREFCTRL_TSEN_Msk & ((uint32_t)(value) << SUPC_VREFCTRL_TSEN_Pos)) /* Assignment of value for TSEN in the SUPC_VREFCTRL register */
...
#define SUPC_BKOUT_EN0(value)                 (SUPC_BKOUT_EN0_Msk & ((uint32_t)(value) << SUPC_BKOUT_EN0_Pos)) /* Assignment of value for EN0 in the SUPC_BKOUT register */
...
#define SUPC_BKOUT_EN1(value)                 (SUPC_BKOUT_EN1_Msk & ((uint32_t)(value) << SUPC_BKOUT_EN1_Pos)) /* Assignment of value for EN1 in the SUPC_BKOUT register */
...
#define SUPC_BKOUT_CLR0(value)                (SUPC_BKOUT_CLR0_Msk & ((uint32_t)(value) << SUPC_BKOUT_CLR0_Pos)) /* Assignment of value for CLR0 in the SUPC_BKOUT register */
...
#define SUPC_BKOUT_CLR1(value)                (SUPC_BKOUT_CLR1_Msk & ((uint32_t)(value) << SUPC_BKOUT_CLR1_Pos)) /* Assignment of value for CLR1 in the SUPC_BKOUT register */
...
#define SUPC_BKOUT_SET0(value)                (SUPC_BKOUT_SET0_Msk & ((uint32_t)(value) << SUPC_BKOUT_SET0_Pos)) /* Assignment of value for SET0 in the SUPC_BKOUT register */
...
#define SUPC_BKOUT_SET1(value)                (SUPC_BKOUT_SET1_Msk & ((uint32_t)(value) << SUPC_BKOUT_SET1_Pos)) /* Assignment of value for SET1 in the SUPC_BKOUT register */
...
#define SUPC_BKOUT_TGLOM0(value)              (SUPC_BKOUT_TGLOM0_Msk & ((uint32_t)(value) << SUPC_BKOUT_TGLOM0_Pos)) /* Assignment of value for TGLOM0 in the SUPC_BKOUT register */
...
#define SUPC_BKOUT_TGLOM1(value)              (SUPC_BKOUT_TGLOM1_Msk & ((uint32_t)(value) << SUPC_BKOUT_TGLOM1_Pos)) /* Assignment of value for TGLOM1 in the SUPC_BKOUT register */
...
#define SUPC_BKOUT_EN(value)                  (SUPC_BKOUT_EN_Msk & ((uint32_t)(value) << SUPC_BKOUT_EN_Pos)) 
...
#define SUPC_BKOUT_CLR(value)                 (SUPC_BKOUT_CLR_Msk & ((uint32_t)(value) << SUPC_BKOUT_CLR_Pos)) 
...
#define SUPC_BKOUT_SET(value)                 (SUPC_BKOUT_SET_Msk & ((uint32_t)(value) << SUPC_BKOUT_SET_Pos)) 
...
#define SUPC_BKIN_BKIN(value)                 (SUPC_BKIN_BKIN_Msk & ((uint32_t)(value) << SUPC_BKIN_BKIN_Pos)) /* Assignment of value for BKIN in the SUPC_BKIN register */
