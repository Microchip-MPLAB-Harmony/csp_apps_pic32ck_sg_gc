...
#define DSU_CTRL_SWRST(value)                 (DSU_CTRL_SWRST_Msk & ((uint32_t)(value) << DSU_CTRL_SWRST_Pos)) /* Assignment of value for SWRST in the DSU_CTRL register */
...
#define DSU_CTRL_CMD(value)                   (DSU_CTRL_CMD_Msk & ((uint32_t)(value) << DSU_CTRL_CMD_Pos)) /* Assignment of value for CMD in the DSU_CTRL register */
...
#define   DSU_CTRL_CMD_MSET_Val               _UINT32_(0xA502)                                     /* (DSU_CTRL) Memory Set  */
...
#define DSU_CTRL_CMD_MSET                     (DSU_CTRL_CMD_MSET_Val << DSU_CTRL_CMD_Pos)          /* (DSU_CTRL) Memory Set Position */
...
#define DSU_ADDR_ADDR(value)                  (DSU_ADDR_ADDR_Msk & ((uint32_t)(value) << DSU_ADDR_ADDR_Pos)) /* Assignment of value for ADDR in the DSU_ADDR register */
...
#define DSU_ADDR_MBIST_AMOD(value)            (DSU_ADDR_MBIST_AMOD_Msk & ((uint32_t)(value) << DSU_ADDR_MBIST_AMOD_Pos))
...
#define DSU_LENGTH_LENGTH(value)              (DSU_LENGTH_LENGTH_Msk & ((uint32_t)(value) << DSU_LENGTH_LENGTH_Pos)) /* Assignment of value for LENGTH in the DSU_LENGTH register */
...
#define DSU_DATA_DATA(value)                  (DSU_DATA_DATA_Msk & ((uint32_t)(value) << DSU_DATA_DATA_Pos)) /* Assignment of value for DATA in the DSU_DATA register */
...
#define DSU_DATA_MBIST_STATE(value)           (DSU_DATA_MBIST_STATE_Msk & ((uint32_t)(value) << DSU_DATA_MBIST_STATE_Pos))
...
#define DSU_DATA_MBIST_INDEX(value)           (DSU_DATA_MBIST_INDEX_Msk & ((uint32_t)(value) << DSU_DATA_MBIST_INDEX_Pos))
...
#define DSU_CFG_DCCDMALEVEL0(value)           (DSU_CFG_DCCDMALEVEL0_Msk & ((uint32_t)(value) << DSU_CFG_DCCDMALEVEL0_Pos)) /* Assignment of value for DCCDMALEVEL0 in the DSU_CFG register */
...
#define DSU_CFG_DCCDMALEVEL1(value)           (DSU_CFG_DCCDMALEVEL1_Msk & ((uint32_t)(value) << DSU_CFG_DCCDMALEVEL1_Pos)) /* Assignment of value for DCCDMALEVEL1 in the DSU_CFG register */
...
#define DSU_CFG_MBFI(value)                   (DSU_CFG_MBFI_Msk & ((uint32_t)(value) << DSU_CFG_MBFI_Pos)) /* Assignment of value for MBFI in the DSU_CFG register */
...
#define DSU_CFG_MISC(value)                   (DSU_CFG_MISC_Msk & ((uint32_t)(value) << DSU_CFG_MISC_Pos)) /* Assignment of value for MISC in the DSU_CFG register */
...
#define DSU_CFG_DCCDMALEVEL(value)            (DSU_CFG_DCCDMALEVEL_Msk & ((uint32_t)(value) << DSU_CFG_DCCDMALEVEL_Pos)) 
...
#define DSU_MBFI0_BIDX(value)                 (DSU_MBFI0_BIDX_Msk & ((uint32_t)(value) << DSU_MBFI0_BIDX_Pos)) /* Assignment of value for BIDX in the DSU_MBFI0 register */
...
#define DSU_MBFI0_AMMOD(value)                (DSU_MBFI0_AMMOD_Msk & ((uint32_t)(value) << DSU_MBFI0_AMMOD_Pos)) /* Assignment of value for AMMOD in the DSU_MBFI0 register */
...
#define DSU_MBFI0_FTYPE(value)                (DSU_MBFI0_FTYPE_Msk & ((uint32_t)(value) << DSU_MBFI0_FTYPE_Pos)) /* Assignment of value for FTYPE in the DSU_MBFI0 register */
...
#define DSU_MBFI0_AMMSK(value)                (DSU_MBFI0_AMMSK_Msk & ((uint32_t)(value) << DSU_MBFI0_AMMSK_Pos)) /* Assignment of value for AMMSK in the DSU_MBFI0 register */
...
#define DSU_MBFI1_ADDR(value)                 (DSU_MBFI1_ADDR_Msk & ((uint32_t)(value) << DSU_MBFI1_ADDR_Pos)) /* Assignment of value for ADDR in the DSU_MBFI1 register */
...
#define DSU_STATUSA_DONE(value)               (DSU_STATUSA_DONE_Msk & ((uint32_t)(value) << DSU_STATUSA_DONE_Pos)) /* Assignment of value for DONE in the DSU_STATUSA register */
...
#define DSU_STATUSA_FAIL(value)               (DSU_STATUSA_FAIL_Msk & ((uint32_t)(value) << DSU_STATUSA_FAIL_Pos)) /* Assignment of value for FAIL in the DSU_STATUSA register */
...
#define DSU_STATUSA_BERR(value)               (DSU_STATUSA_BERR_Msk & ((uint32_t)(value) << DSU_STATUSA_BERR_Pos)) /* Assignment of value for BERR in the DSU_STATUSA register */
...
#define DSU_STATUSA_PERR(value)               (DSU_STATUSA_PERR_Msk & ((uint32_t)(value) << DSU_STATUSA_PERR_Pos)) /* Assignment of value for PERR in the DSU_STATUSA register */
...
#define DSU_STATUSA_CRSTEXT0(value)           (DSU_STATUSA_CRSTEXT0_Msk & ((uint32_t)(value) << DSU_STATUSA_CRSTEXT0_Pos)) /* Assignment of value for CRSTEXT0 in the DSU_STATUSA register */
...
#define DSU_STATUSA_CRSTEXT1(value)           (DSU_STATUSA_CRSTEXT1_Msk & ((uint32_t)(value) << DSU_STATUSA_CRSTEXT1_Pos)) /* Assignment of value for CRSTEXT1 in the DSU_STATUSA register */
...
#define DSU_STATUSA_BREXT0(value)             (DSU_STATUSA_BREXT0_Msk & ((uint32_t)(value) << DSU_STATUSA_BREXT0_Pos)) /* Assignment of value for BREXT0 in the DSU_STATUSA register */
...
#define DSU_STATUSA_BREXT1(value)             (DSU_STATUSA_BREXT1_Msk & ((uint32_t)(value) << DSU_STATUSA_BREXT1_Pos)) /* Assignment of value for BREXT1 in the DSU_STATUSA register */
#define DSU_STATUSA_Msk                       _UINT32_(0x0003030F)                                 /* (DSU_STATUSA) Register Mask  */

#define DSU_STATUSA_CRSTEXT_Pos               _UINT32_(8)                                          /* (DSU_STATUSA Position) CPU x Reset Phase Extension */
#define DSU_STATUSA_CRSTEXT_Msk               (_UINT32_(0x3) << DSU_STATUSA_CRSTEXT_Pos)           /* (DSU_STATUSA Mask) CRSTEXT */
#define DSU_STATUSA_CRSTEXT(value)            (DSU_STATUSA_CRSTEXT_Msk & ((uint32_t)(value) << DSU_STATUSA_CRSTEXT_Pos)) 
#define DSU_STATUSA_BREXT_Pos                 _UINT32_(16)                                         /* (DSU_STATUSA Position) BootRom x Phase Extension */
#define DSU_STATUSA_BREXT_Msk                 (_UINT32_(0x3) << DSU_STATUSA_BREXT_Pos)             /* (DSU_STATUSA Mask) BREXT */
#define DSU_STATUSA_BREXT(value)              (DSU_STATUSA_BREXT_Msk & ((uint32_t)(value) << DSU_STATUSA_BREXT_Pos)) 
...
#define DSU_STATUSB_BCCD0(value)              (DSU_STATUSB_BCCD0_Msk & ((uint32_t)(value) << DSU_STATUSB_BCCD0_Pos)) /* Assignment of value for BCCD0 in the DSU_STATUSB register */
...
#define DSU_STATUSB_BCCD1(value)              (DSU_STATUSB_BCCD1_Msk & ((uint32_t)(value) << DSU_STATUSB_BCCD1_Pos)) /* Assignment of value for BCCD1 in the DSU_STATUSB register */
...
#define DSU_STATUSB_DCCD0(value)              (DSU_STATUSB_DCCD0_Msk & ((uint32_t)(value) << DSU_STATUSB_DCCD0_Pos)) /* Assignment of value for DCCD0 in the DSU_STATUSB register */
...
#define DSU_STATUSB_DCCD1(value)              (DSU_STATUSB_DCCD1_Msk & ((uint32_t)(value) << DSU_STATUSB_DCCD1_Pos)) /* Assignment of value for DCCD1 in the DSU_STATUSB register */
...
#define DSU_STATUSB_DBGPRES(value)            (DSU_STATUSB_DBGPRES_Msk & ((uint32_t)(value) << DSU_STATUSB_DBGPRES_Pos)) /* Assignment of value for DBGPRES in the DSU_STATUSB register */
...
#define DSU_STATUSB_HPE(value)                (DSU_STATUSB_HPE_Msk & ((uint32_t)(value) << DSU_STATUSB_HPE_Pos)) /* Assignment of value for HPE in the DSU_STATUSB register */
...
#define DSU_STATUSB_BCCD(value)               (DSU_STATUSB_BCCD_Msk & ((uint32_t)(value) << DSU_STATUSB_BCCD_Pos)) 
...
#define DSU_STATUSB_DCCD(value)               (DSU_STATUSB_DCCD_Msk & ((uint32_t)(value) << DSU_STATUSB_DCCD_Pos)) 
...
#define DSU_STATUSC_STATE(value)              (DSU_STATUSC_STATE_Msk & ((uint32_t)(value) << DSU_STATUSC_STATE_Pos)) /* Assignment of value for STATE in the DSU_STATUSC register */
#define   DSU_STATUSC_STATE_IDLE_Val          _UINT32_(0x0)                                        /* (DSU_STATUSC) State Machine Ready  */
#define   DSU_STATUSC_STATE_CRC32_Val         _UINT32_(0x1)                                        /* (DSU_STATUSC) CRC32 Operation Ongoing  */
#define   DSU_STATUSC_STATE_MSET_Val          _UINT32_(0x4)                                        /* (DSU_STATUSC) Memory Set  */
...
#define DSU_STATUSC_STATE_CRC32               (DSU_STATUSC_STATE_CRC32_Val << DSU_STATUSC_STATE_Pos) /* (DSU_STATUSC) CRC32 Operation Ongoing Position */
#define DSU_STATUSC_STATE_MSET                (DSU_STATUSC_STATE_MSET_Val << DSU_STATUSC_STATE_Pos) /* (DSU_STATUSC) Memory Set Position */
...
#define DSU_STATUSC_INDEX(value)              (DSU_STATUSC_INDEX_Msk & ((uint32_t)(value) << DSU_STATUSC_INDEX_Pos)) /* Assignment of value for INDEX in the DSU_STATUSC register */
...
#define DSU_BCC_DATA(value)                   (DSU_BCC_DATA_Msk & ((uint32_t)(value) << DSU_BCC_DATA_Pos)) /* Assignment of value for DATA in the DSU_BCC register */
...
#define DSU_DCC_DATA(value)                   (DSU_DCC_DATA_Msk & ((uint32_t)(value) << DSU_DCC_DATA_Pos)) /* Assignment of value for DATA in the DSU_DCC register */
...
#define DSU_DID_MARKER(value)                 (DSU_DID_MARKER_Msk & ((uint32_t)(value) << DSU_DID_MARKER_Pos)) /* Assignment of value for MARKER in the DSU_DID register */
...
#define DSU_DID_MANID(value)                  (DSU_DID_MANID_Msk & ((uint32_t)(value) << DSU_DID_MANID_Pos)) /* Assignment of value for MANID in the DSU_DID register */
...
#define DSU_DID_DEVSEL(value)                 (DSU_DID_DEVSEL_Msk & ((uint32_t)(value) << DSU_DID_DEVSEL_Pos)) /* Assignment of value for DEVSEL in the DSU_DID register */
...
#define DSU_DID_PRODUCT(value)                (DSU_DID_PRODUCT_Msk & ((uint32_t)(value) << DSU_DID_PRODUCT_Pos)) /* Assignment of value for PRODUCT in the DSU_DID register */
...
#define DSU_DID_REVISION(value)               (DSU_DID_REVISION_Msk & ((uint32_t)(value) << DSU_DID_REVISION_Pos)) /* Assignment of value for REVISION in the DSU_DID register */
...
#define DSU_DAL_CPU0(value)                   (DSU_DAL_CPU0_Msk & ((uint32_t)(value) << DSU_DAL_CPU0_Pos)) /* Assignment of value for CPU0 in the DSU_DAL register */
...
#define DSU_DAL_CPU1(value)                   (DSU_DAL_CPU1_Msk & ((uint32_t)(value) << DSU_DAL_CPU1_Pos)) /* Assignment of value for CPU1 in the DSU_DAL register */
...
#define DSU_DAL_Msk                           _UINT32_(0x0000000F)                                 /* (DSU_DAL) Register Mask  */
...
#define DSU_ENTRY_EPRES(value)                (DSU_ENTRY_EPRES_Msk & ((uint32_t)(value) << DSU_ENTRY_EPRES_Pos)) /* Assignment of value for EPRES in the DSU_ENTRY register */
...
#define DSU_ENTRY_FMT(value)                  (DSU_ENTRY_FMT_Msk & ((uint32_t)(value) << DSU_ENTRY_FMT_Pos)) /* Assignment of value for FMT in the DSU_ENTRY register */
...
#define DSU_ENTRY_ADDOFF(value)               (DSU_ENTRY_ADDOFF_Msk & ((uint32_t)(value) << DSU_ENTRY_ADDOFF_Pos)) /* Assignment of value for ADDOFF in the DSU_ENTRY register */
...
#define DSU_MEMTYPE_SMEMP(value)              (DSU_MEMTYPE_SMEMP_Msk & ((uint32_t)(value) << DSU_MEMTYPE_SMEMP_Pos)) /* Assignment of value for SMEMP in the DSU_MEMTYPE register */
...
#define DSU_PID4_JEPCC(value)                 (DSU_PID4_JEPCC_Msk & ((uint32_t)(value) << DSU_PID4_JEPCC_Pos)) /* Assignment of value for JEPCC in the DSU_PID4 register */
...
#define DSU_PID4_FKBC(value)                  (DSU_PID4_FKBC_Msk & ((uint32_t)(value) << DSU_PID4_FKBC_Pos)) /* Assignment of value for FKBC in the DSU_PID4 register */
...
#define DSU_PID0_PARTNBL(value)               (DSU_PID0_PARTNBL_Msk & ((uint32_t)(value) << DSU_PID0_PARTNBL_Pos)) /* Assignment of value for PARTNBL in the DSU_PID0 register */
...
#define DSU_PID1_PARTNBH(value)               (DSU_PID1_PARTNBH_Msk & ((uint32_t)(value) << DSU_PID1_PARTNBH_Pos)) /* Assignment of value for PARTNBH in the DSU_PID1 register */
...
#define DSU_PID1_JEPIDCL(value)               (DSU_PID1_JEPIDCL_Msk & ((uint32_t)(value) << DSU_PID1_JEPIDCL_Pos)) /* Assignment of value for JEPIDCL in the DSU_PID1 register */
...
#define DSU_PID2_JEPIDCH(value)               (DSU_PID2_JEPIDCH_Msk & ((uint32_t)(value) << DSU_PID2_JEPIDCH_Pos)) /* Assignment of value for JEPIDCH in the DSU_PID2 register */
...
#define DSU_PID2_JEPU(value)                  (DSU_PID2_JEPU_Msk & ((uint32_t)(value) << DSU_PID2_JEPU_Pos)) /* Assignment of value for JEPU in the DSU_PID2 register */
...
#define DSU_PID2_REVISION(value)              (DSU_PID2_REVISION_Msk & ((uint32_t)(value) << DSU_PID2_REVISION_Pos)) /* Assignment of value for REVISION in the DSU_PID2 register */
...
#define DSU_PID3_CUSMOD(value)                (DSU_PID3_CUSMOD_Msk & ((uint32_t)(value) << DSU_PID3_CUSMOD_Pos)) /* Assignment of value for CUSMOD in the DSU_PID3 register */
...
#define DSU_PID3_REVAND(value)                (DSU_PID3_REVAND_Msk & ((uint32_t)(value) << DSU_PID3_REVAND_Pos)) /* Assignment of value for REVAND in the DSU_PID3 register */
...
#define DSU_CID0_PREAMBLEB0(value)            (DSU_CID0_PREAMBLEB0_Msk & ((uint32_t)(value) << DSU_CID0_PREAMBLEB0_Pos)) /* Assignment of value for PREAMBLEB0 in the DSU_CID0 register */
...
#define DSU_CID1_PREAMBLE(value)              (DSU_CID1_PREAMBLE_Msk & ((uint32_t)(value) << DSU_CID1_PREAMBLE_Pos)) /* Assignment of value for PREAMBLE in the DSU_CID1 register */
...
#define DSU_CID1_CCLASS(value)                (DSU_CID1_CCLASS_Msk & ((uint32_t)(value) << DSU_CID1_CCLASS_Pos)) /* Assignment of value for CCLASS in the DSU_CID1 register */
...
#define DSU_CID2_PREAMBLEB2(value)            (DSU_CID2_PREAMBLEB2_Msk & ((uint32_t)(value) << DSU_CID2_PREAMBLEB2_Pos)) /* Assignment of value for PREAMBLEB2 in the DSU_CID2 register */
...
#define DSU_CID3_PREAMBLEB3(value)            (DSU_CID3_PREAMBLEB3_Msk & ((uint32_t)(value) << DSU_CID3_PREAMBLEB3_Pos)) /* Assignment of value for PREAMBLEB3 in the DSU_CID3 register */
