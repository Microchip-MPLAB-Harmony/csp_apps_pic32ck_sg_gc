...
#define USB_DEVICE_ADDR_ADDR(value)           (USB_DEVICE_ADDR_ADDR_Msk & ((uint32_t)(value) << USB_DEVICE_ADDR_ADDR_Pos)) /* Assignment of value for ADDR in the USB_DEVICE_ADDR register */
...
#define USB_DEVICE_PCKSIZE_BYTE_COUNT(value)  (USB_DEVICE_PCKSIZE_BYTE_COUNT_Msk & ((uint32_t)(value) << USB_DEVICE_PCKSIZE_BYTE_COUNT_Pos)) /* Assignment of value for BYTE_COUNT in the USB_DEVICE_PCKSIZE register */
...
#define USB_DEVICE_PCKSIZE_MULTI_PACKET_SIZE(value) (USB_DEVICE_PCKSIZE_MULTI_PACKET_SIZE_Msk & ((uint32_t)(value) << USB_DEVICE_PCKSIZE_MULTI_PACKET_SIZE_Pos)) /* Assignment of value for MULTI_PACKET_SIZE in the USB_DEVICE_PCKSIZE register */
...
#define USB_DEVICE_PCKSIZE_SIZE(value)        (USB_DEVICE_PCKSIZE_SIZE_Msk & ((uint32_t)(value) << USB_DEVICE_PCKSIZE_SIZE_Pos)) /* Assignment of value for SIZE in the USB_DEVICE_PCKSIZE register */
...
#define USB_DEVICE_PCKSIZE_AUTO_ZLP(value)    (USB_DEVICE_PCKSIZE_AUTO_ZLP_Msk & ((uint32_t)(value) << USB_DEVICE_PCKSIZE_AUTO_ZLP_Pos)) /* Assignment of value for AUTO_ZLP in the USB_DEVICE_PCKSIZE register */
...
#define USB_DEVICE_EXTREG_SUBPID(value)       (USB_DEVICE_EXTREG_SUBPID_Msk & ((uint16_t)(value) << USB_DEVICE_EXTREG_SUBPID_Pos)) /* Assignment of value for SUBPID in the USB_DEVICE_EXTREG register */
...
#define USB_DEVICE_EXTREG_VARIABLE(value)     (USB_DEVICE_EXTREG_VARIABLE_Msk & ((uint16_t)(value) << USB_DEVICE_EXTREG_VARIABLE_Pos)) /* Assignment of value for VARIABLE in the USB_DEVICE_EXTREG register */
...
#define USB_DEVICE_STATUS_BK_CRCERR(value)    (USB_DEVICE_STATUS_BK_CRCERR_Msk & ((uint8_t)(value) << USB_DEVICE_STATUS_BK_CRCERR_Pos)) /* Assignment of value for CRCERR in the USB_DEVICE_STATUS_BK register */
...
#define USB_DEVICE_STATUS_BK_ERRORFLOW(value) (USB_DEVICE_STATUS_BK_ERRORFLOW_Msk & ((uint8_t)(value) << USB_DEVICE_STATUS_BK_ERRORFLOW_Pos)) /* Assignment of value for ERRORFLOW in the USB_DEVICE_STATUS_BK register */
...
#define USB_HOST_ADDR_ADDR(value)             (USB_HOST_ADDR_ADDR_Msk & ((uint32_t)(value) << USB_HOST_ADDR_ADDR_Pos)) /* Assignment of value for ADDR in the USB_HOST_ADDR register */
...
#define USB_HOST_PCKSIZE_BYTE_COUNT(value)    (USB_HOST_PCKSIZE_BYTE_COUNT_Msk & ((uint32_t)(value) << USB_HOST_PCKSIZE_BYTE_COUNT_Pos)) /* Assignment of value for BYTE_COUNT in the USB_HOST_PCKSIZE register */
...
#define USB_HOST_PCKSIZE_MULTI_PACKET_SIZE(value) (USB_HOST_PCKSIZE_MULTI_PACKET_SIZE_Msk & ((uint32_t)(value) << USB_HOST_PCKSIZE_MULTI_PACKET_SIZE_Pos)) /* Assignment of value for MULTI_PACKET_SIZE in the USB_HOST_PCKSIZE register */
...
#define USB_HOST_PCKSIZE_SIZE(value)          (USB_HOST_PCKSIZE_SIZE_Msk & ((uint32_t)(value) << USB_HOST_PCKSIZE_SIZE_Pos)) /* Assignment of value for SIZE in the USB_HOST_PCKSIZE register */
...
#define USB_HOST_PCKSIZE_AUTO_ZLP(value)      (USB_HOST_PCKSIZE_AUTO_ZLP_Msk & ((uint32_t)(value) << USB_HOST_PCKSIZE_AUTO_ZLP_Pos)) /* Assignment of value for AUTO_ZLP in the USB_HOST_PCKSIZE register */
...
#define USB_HOST_EXTREG_SUBPID(value)         (USB_HOST_EXTREG_SUBPID_Msk & ((uint16_t)(value) << USB_HOST_EXTREG_SUBPID_Pos)) /* Assignment of value for SUBPID in the USB_HOST_EXTREG register */
...
#define USB_HOST_EXTREG_VARIABLE(value)       (USB_HOST_EXTREG_VARIABLE_Msk & ((uint16_t)(value) << USB_HOST_EXTREG_VARIABLE_Pos)) /* Assignment of value for VARIABLE in the USB_HOST_EXTREG register */
...
#define USB_HOST_STATUS_BK_CRCERR(value)      (USB_HOST_STATUS_BK_CRCERR_Msk & ((uint8_t)(value) << USB_HOST_STATUS_BK_CRCERR_Pos)) /* Assignment of value for CRCERR in the USB_HOST_STATUS_BK register */
...
#define USB_HOST_STATUS_BK_ERRORFLOW(value)   (USB_HOST_STATUS_BK_ERRORFLOW_Msk & ((uint8_t)(value) << USB_HOST_STATUS_BK_ERRORFLOW_Pos)) /* Assignment of value for ERRORFLOW in the USB_HOST_STATUS_BK register */
...
#define USB_HOST_CTRL_PIPE_PDADDR(value)      (USB_HOST_CTRL_PIPE_PDADDR_Msk & ((uint16_t)(value) << USB_HOST_CTRL_PIPE_PDADDR_Pos)) /* Assignment of value for PDADDR in the USB_HOST_CTRL_PIPE register */
...
#define USB_HOST_CTRL_PIPE_PEPNUM(value)      (USB_HOST_CTRL_PIPE_PEPNUM_Msk & ((uint16_t)(value) << USB_HOST_CTRL_PIPE_PEPNUM_Pos)) /* Assignment of value for PEPNUM in the USB_HOST_CTRL_PIPE register */
...
#define USB_HOST_CTRL_PIPE_PERMAX(value)      (USB_HOST_CTRL_PIPE_PERMAX_Msk & ((uint16_t)(value) << USB_HOST_CTRL_PIPE_PERMAX_Pos)) /* Assignment of value for PERMAX in the USB_HOST_CTRL_PIPE register */
...
#define USB_HOST_STATUS_PIPE_DTGLER(value)    (USB_HOST_STATUS_PIPE_DTGLER_Msk & ((uint16_t)(value) << USB_HOST_STATUS_PIPE_DTGLER_Pos)) /* Assignment of value for DTGLER in the USB_HOST_STATUS_PIPE register */
...
#define USB_HOST_STATUS_PIPE_DAPIDER(value)   (USB_HOST_STATUS_PIPE_DAPIDER_Msk & ((uint16_t)(value) << USB_HOST_STATUS_PIPE_DAPIDER_Pos)) /* Assignment of value for DAPIDER in the USB_HOST_STATUS_PIPE register */
...
#define USB_HOST_STATUS_PIPE_PIDER(value)     (USB_HOST_STATUS_PIPE_PIDER_Msk & ((uint16_t)(value) << USB_HOST_STATUS_PIPE_PIDER_Pos)) /* Assignment of value for PIDER in the USB_HOST_STATUS_PIPE register */
...
#define USB_HOST_STATUS_PIPE_TOUTER(value)    (USB_HOST_STATUS_PIPE_TOUTER_Msk & ((uint16_t)(value) << USB_HOST_STATUS_PIPE_TOUTER_Pos)) /* Assignment of value for TOUTER in the USB_HOST_STATUS_PIPE register */
...
#define USB_HOST_STATUS_PIPE_CRC16ER(value)   (USB_HOST_STATUS_PIPE_CRC16ER_Msk & ((uint16_t)(value) << USB_HOST_STATUS_PIPE_CRC16ER_Pos)) /* Assignment of value for CRC16ER in the USB_HOST_STATUS_PIPE register */
...
#define USB_HOST_STATUS_PIPE_ERCNT(value)     (USB_HOST_STATUS_PIPE_ERCNT_Msk & ((uint16_t)(value) << USB_HOST_STATUS_PIPE_ERCNT_Pos)) /* Assignment of value for ERCNT in the USB_HOST_STATUS_PIPE register */
...
#define USB_DEVICE_EPCFG_EPTYPE0(value)       (USB_DEVICE_EPCFG_EPTYPE0_Msk & ((uint8_t)(value) << USB_DEVICE_EPCFG_EPTYPE0_Pos)) /* Assignment of value for EPTYPE0 in the USB_DEVICE_EPCFG register */
...
#define USB_DEVICE_EPCFG_EPTYPE1(value)       (USB_DEVICE_EPCFG_EPTYPE1_Msk & ((uint8_t)(value) << USB_DEVICE_EPCFG_EPTYPE1_Pos)) /* Assignment of value for EPTYPE1 in the USB_DEVICE_EPCFG register */
...
#define USB_DEVICE_EPCFG_NYETDIS(value)       (USB_DEVICE_EPCFG_NYETDIS_Msk & ((uint8_t)(value) << USB_DEVICE_EPCFG_NYETDIS_Pos)) /* Assignment of value for NYETDIS in the USB_DEVICE_EPCFG register */
...
#define USB_DEVICE_EPSTATUSCLR_DTGLOUT(value) (USB_DEVICE_EPSTATUSCLR_DTGLOUT_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSCLR_DTGLOUT_Pos)) /* Assignment of value for DTGLOUT in the USB_DEVICE_EPSTATUSCLR register */
...
#define USB_DEVICE_EPSTATUSCLR_DTGLIN(value)  (USB_DEVICE_EPSTATUSCLR_DTGLIN_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSCLR_DTGLIN_Pos)) /* Assignment of value for DTGLIN in the USB_DEVICE_EPSTATUSCLR register */
...
#define USB_DEVICE_EPSTATUSCLR_CURBK(value)   (USB_DEVICE_EPSTATUSCLR_CURBK_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSCLR_CURBK_Pos)) /* Assignment of value for CURBK in the USB_DEVICE_EPSTATUSCLR register */
...
#define USB_DEVICE_EPSTATUSCLR_STALLRQ0(value) (USB_DEVICE_EPSTATUSCLR_STALLRQ0_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSCLR_STALLRQ0_Pos)) /* Assignment of value for STALLRQ0 in the USB_DEVICE_EPSTATUSCLR register */
...
#define USB_DEVICE_EPSTATUSCLR_STALLRQ1(value) (USB_DEVICE_EPSTATUSCLR_STALLRQ1_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSCLR_STALLRQ1_Pos)) /* Assignment of value for STALLRQ1 in the USB_DEVICE_EPSTATUSCLR register */
...
#define USB_DEVICE_EPSTATUSCLR_BK0RDY(value)  (USB_DEVICE_EPSTATUSCLR_BK0RDY_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSCLR_BK0RDY_Pos)) /* Assignment of value for BK0RDY in the USB_DEVICE_EPSTATUSCLR register */
...
#define USB_DEVICE_EPSTATUSCLR_BK1RDY(value)  (USB_DEVICE_EPSTATUSCLR_BK1RDY_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSCLR_BK1RDY_Pos)) /* Assignment of value for BK1RDY in the USB_DEVICE_EPSTATUSCLR register */
...
#define USB_DEVICE_EPSTATUSCLR_STALLRQ(value) (USB_DEVICE_EPSTATUSCLR_STALLRQ_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSCLR_STALLRQ_Pos)) 
...
#define USB_DEVICE_EPSTATUSSET_DTGLOUT(value) (USB_DEVICE_EPSTATUSSET_DTGLOUT_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSSET_DTGLOUT_Pos)) /* Assignment of value for DTGLOUT in the USB_DEVICE_EPSTATUSSET register */
...
#define USB_DEVICE_EPSTATUSSET_DTGLIN(value)  (USB_DEVICE_EPSTATUSSET_DTGLIN_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSSET_DTGLIN_Pos)) /* Assignment of value for DTGLIN in the USB_DEVICE_EPSTATUSSET register */
...
#define USB_DEVICE_EPSTATUSSET_CURBK(value)   (USB_DEVICE_EPSTATUSSET_CURBK_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSSET_CURBK_Pos)) /* Assignment of value for CURBK in the USB_DEVICE_EPSTATUSSET register */
...
#define USB_DEVICE_EPSTATUSSET_STALLRQ0(value) (USB_DEVICE_EPSTATUSSET_STALLRQ0_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSSET_STALLRQ0_Pos)) /* Assignment of value for STALLRQ0 in the USB_DEVICE_EPSTATUSSET register */
...
#define USB_DEVICE_EPSTATUSSET_STALLRQ1(value) (USB_DEVICE_EPSTATUSSET_STALLRQ1_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSSET_STALLRQ1_Pos)) /* Assignment of value for STALLRQ1 in the USB_DEVICE_EPSTATUSSET register */
...
#define USB_DEVICE_EPSTATUSSET_BK0RDY(value)  (USB_DEVICE_EPSTATUSSET_BK0RDY_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSSET_BK0RDY_Pos)) /* Assignment of value for BK0RDY in the USB_DEVICE_EPSTATUSSET register */
...
#define USB_DEVICE_EPSTATUSSET_BK1RDY(value)  (USB_DEVICE_EPSTATUSSET_BK1RDY_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSSET_BK1RDY_Pos)) /* Assignment of value for BK1RDY in the USB_DEVICE_EPSTATUSSET register */
...
#define USB_DEVICE_EPSTATUSSET_STALLRQ(value) (USB_DEVICE_EPSTATUSSET_STALLRQ_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUSSET_STALLRQ_Pos)) 
...
#define USB_DEVICE_EPSTATUS_DTGLOUT(value)    (USB_DEVICE_EPSTATUS_DTGLOUT_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUS_DTGLOUT_Pos)) /* Assignment of value for DTGLOUT in the USB_DEVICE_EPSTATUS register */
...
#define USB_DEVICE_EPSTATUS_DTGLIN(value)     (USB_DEVICE_EPSTATUS_DTGLIN_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUS_DTGLIN_Pos)) /* Assignment of value for DTGLIN in the USB_DEVICE_EPSTATUS register */
...
#define USB_DEVICE_EPSTATUS_CURBK(value)      (USB_DEVICE_EPSTATUS_CURBK_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUS_CURBK_Pos)) /* Assignment of value for CURBK in the USB_DEVICE_EPSTATUS register */
...
#define USB_DEVICE_EPSTATUS_STALLRQ0(value)   (USB_DEVICE_EPSTATUS_STALLRQ0_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUS_STALLRQ0_Pos)) /* Assignment of value for STALLRQ0 in the USB_DEVICE_EPSTATUS register */
...
#define USB_DEVICE_EPSTATUS_STALLRQ1(value)   (USB_DEVICE_EPSTATUS_STALLRQ1_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUS_STALLRQ1_Pos)) /* Assignment of value for STALLRQ1 in the USB_DEVICE_EPSTATUS register */
...
#define USB_DEVICE_EPSTATUS_BK0RDY(value)     (USB_DEVICE_EPSTATUS_BK0RDY_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUS_BK0RDY_Pos)) /* Assignment of value for BK0RDY in the USB_DEVICE_EPSTATUS register */
...
#define USB_DEVICE_EPSTATUS_BK1RDY(value)     (USB_DEVICE_EPSTATUS_BK1RDY_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUS_BK1RDY_Pos)) /* Assignment of value for BK1RDY in the USB_DEVICE_EPSTATUS register */
...
#define USB_DEVICE_EPSTATUS_STALLRQ(value)    (USB_DEVICE_EPSTATUS_STALLRQ_Msk & ((uint8_t)(value) << USB_DEVICE_EPSTATUS_STALLRQ_Pos)) 
...
#define USB_DEVICE_EPINTFLAG_TRCPT0(value)    (USB_DEVICE_EPINTFLAG_TRCPT0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_TRCPT0_Pos)) /* Assignment of value for TRCPT0 in the USB_DEVICE_EPINTFLAG register */
...
#define USB_DEVICE_EPINTFLAG_TRCPT1(value)    (USB_DEVICE_EPINTFLAG_TRCPT1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_TRCPT1_Pos)) /* Assignment of value for TRCPT1 in the USB_DEVICE_EPINTFLAG register */
...
#define USB_DEVICE_EPINTFLAG_TRFAIL0(value)   (USB_DEVICE_EPINTFLAG_TRFAIL0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_TRFAIL0_Pos)) /* Assignment of value for TRFAIL0 in the USB_DEVICE_EPINTFLAG register */
...
#define USB_DEVICE_EPINTFLAG_TRFAIL1(value)   (USB_DEVICE_EPINTFLAG_TRFAIL1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_TRFAIL1_Pos)) /* Assignment of value for TRFAIL1 in the USB_DEVICE_EPINTFLAG register */
...
#define USB_DEVICE_EPINTFLAG_RXSTP(value)     (USB_DEVICE_EPINTFLAG_RXSTP_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_RXSTP_Pos)) /* Assignment of value for RXSTP in the USB_DEVICE_EPINTFLAG register */
...
#define USB_DEVICE_EPINTFLAG_STALL0(value)    (USB_DEVICE_EPINTFLAG_STALL0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_STALL0_Pos)) /* Assignment of value for STALL0 in the USB_DEVICE_EPINTFLAG register */
...
#define USB_DEVICE_EPINTFLAG_STALL1(value)    (USB_DEVICE_EPINTFLAG_STALL1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_STALL1_Pos)) /* Assignment of value for STALL1 in the USB_DEVICE_EPINTFLAG register */
...
#define USB_DEVICE_EPINTFLAG_TRCPT(value)     (USB_DEVICE_EPINTFLAG_TRCPT_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_TRCPT_Pos)) 
...
#define USB_DEVICE_EPINTFLAG_TRFAIL(value)    (USB_DEVICE_EPINTFLAG_TRFAIL_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_TRFAIL_Pos)) 
...
#define USB_DEVICE_EPINTFLAG_STALL(value)     (USB_DEVICE_EPINTFLAG_STALL_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTFLAG_STALL_Pos)) 
...
#define USB_DEVICE_EPINTENCLR_TRCPT0(value)   (USB_DEVICE_EPINTENCLR_TRCPT0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_TRCPT0_Pos)) /* Assignment of value for TRCPT0 in the USB_DEVICE_EPINTENCLR register */
...
#define USB_DEVICE_EPINTENCLR_TRCPT1(value)   (USB_DEVICE_EPINTENCLR_TRCPT1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_TRCPT1_Pos)) /* Assignment of value for TRCPT1 in the USB_DEVICE_EPINTENCLR register */
...
#define USB_DEVICE_EPINTENCLR_TRFAIL0(value)  (USB_DEVICE_EPINTENCLR_TRFAIL0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_TRFAIL0_Pos)) /* Assignment of value for TRFAIL0 in the USB_DEVICE_EPINTENCLR register */
...
#define USB_DEVICE_EPINTENCLR_TRFAIL1(value)  (USB_DEVICE_EPINTENCLR_TRFAIL1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_TRFAIL1_Pos)) /* Assignment of value for TRFAIL1 in the USB_DEVICE_EPINTENCLR register */
...
#define USB_DEVICE_EPINTENCLR_RXSTP(value)    (USB_DEVICE_EPINTENCLR_RXSTP_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_RXSTP_Pos)) /* Assignment of value for RXSTP in the USB_DEVICE_EPINTENCLR register */
...
#define USB_DEVICE_EPINTENCLR_STALL0(value)   (USB_DEVICE_EPINTENCLR_STALL0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_STALL0_Pos)) /* Assignment of value for STALL0 in the USB_DEVICE_EPINTENCLR register */
...
#define USB_DEVICE_EPINTENCLR_STALL1(value)   (USB_DEVICE_EPINTENCLR_STALL1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_STALL1_Pos)) /* Assignment of value for STALL1 in the USB_DEVICE_EPINTENCLR register */
...
#define USB_DEVICE_EPINTENCLR_TRCPT(value)    (USB_DEVICE_EPINTENCLR_TRCPT_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_TRCPT_Pos)) 
...
#define USB_DEVICE_EPINTENCLR_TRFAIL(value)   (USB_DEVICE_EPINTENCLR_TRFAIL_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_TRFAIL_Pos)) 
...
#define USB_DEVICE_EPINTENCLR_STALL(value)    (USB_DEVICE_EPINTENCLR_STALL_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENCLR_STALL_Pos)) 
...
#define USB_DEVICE_EPINTENSET_TRCPT0(value)   (USB_DEVICE_EPINTENSET_TRCPT0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_TRCPT0_Pos)) /* Assignment of value for TRCPT0 in the USB_DEVICE_EPINTENSET register */
...
#define USB_DEVICE_EPINTENSET_TRCPT1(value)   (USB_DEVICE_EPINTENSET_TRCPT1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_TRCPT1_Pos)) /* Assignment of value for TRCPT1 in the USB_DEVICE_EPINTENSET register */
...
#define USB_DEVICE_EPINTENSET_TRFAIL0(value)  (USB_DEVICE_EPINTENSET_TRFAIL0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_TRFAIL0_Pos)) /* Assignment of value for TRFAIL0 in the USB_DEVICE_EPINTENSET register */
...
#define USB_DEVICE_EPINTENSET_TRFAIL1(value)  (USB_DEVICE_EPINTENSET_TRFAIL1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_TRFAIL1_Pos)) /* Assignment of value for TRFAIL1 in the USB_DEVICE_EPINTENSET register */
...
#define USB_DEVICE_EPINTENSET_RXSTP(value)    (USB_DEVICE_EPINTENSET_RXSTP_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_RXSTP_Pos)) /* Assignment of value for RXSTP in the USB_DEVICE_EPINTENSET register */
...
#define USB_DEVICE_EPINTENSET_STALL0(value)   (USB_DEVICE_EPINTENSET_STALL0_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_STALL0_Pos)) /* Assignment of value for STALL0 in the USB_DEVICE_EPINTENSET register */
...
#define USB_DEVICE_EPINTENSET_STALL1(value)   (USB_DEVICE_EPINTENSET_STALL1_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_STALL1_Pos)) /* Assignment of value for STALL1 in the USB_DEVICE_EPINTENSET register */
...
#define USB_DEVICE_EPINTENSET_TRCPT(value)    (USB_DEVICE_EPINTENSET_TRCPT_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_TRCPT_Pos)) 
...
#define USB_DEVICE_EPINTENSET_TRFAIL(value)   (USB_DEVICE_EPINTENSET_TRFAIL_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_TRFAIL_Pos)) 
...
#define USB_DEVICE_EPINTENSET_STALL(value)    (USB_DEVICE_EPINTENSET_STALL_Msk & ((uint8_t)(value) << USB_DEVICE_EPINTENSET_STALL_Pos)) 
...
#define USB_HOST_PCFG_PTOKEN(value)           (USB_HOST_PCFG_PTOKEN_Msk & ((uint8_t)(value) << USB_HOST_PCFG_PTOKEN_Pos)) /* Assignment of value for PTOKEN in the USB_HOST_PCFG register */
...
#define USB_HOST_PCFG_BK(value)               (USB_HOST_PCFG_BK_Msk & ((uint8_t)(value) << USB_HOST_PCFG_BK_Pos)) /* Assignment of value for BK in the USB_HOST_PCFG register */
...
#define USB_HOST_PCFG_PTYPE(value)            (USB_HOST_PCFG_PTYPE_Msk & ((uint8_t)(value) << USB_HOST_PCFG_PTYPE_Pos)) /* Assignment of value for PTYPE in the USB_HOST_PCFG register */
...
#define USB_HOST_BINTERVAL_BITINTERVAL(value) (USB_HOST_BINTERVAL_BITINTERVAL_Msk & ((uint8_t)(value) << USB_HOST_BINTERVAL_BITINTERVAL_Pos)) /* Assignment of value for BITINTERVAL in the USB_HOST_BINTERVAL register */
...
#define USB_HOST_PSTATUSCLR_DTGL(value)       (USB_HOST_PSTATUSCLR_DTGL_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSCLR_DTGL_Pos)) /* Assignment of value for DTGL in the USB_HOST_PSTATUSCLR register */
...
#define USB_HOST_PSTATUSCLR_CURBK(value)      (USB_HOST_PSTATUSCLR_CURBK_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSCLR_CURBK_Pos)) /* Assignment of value for CURBK in the USB_HOST_PSTATUSCLR register */
...
#define USB_HOST_PSTATUSCLR_PFREEZE(value)    (USB_HOST_PSTATUSCLR_PFREEZE_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSCLR_PFREEZE_Pos)) /* Assignment of value for PFREEZE in the USB_HOST_PSTATUSCLR register */
...
#define USB_HOST_PSTATUSCLR_BK0RDY(value)     (USB_HOST_PSTATUSCLR_BK0RDY_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSCLR_BK0RDY_Pos)) /* Assignment of value for BK0RDY in the USB_HOST_PSTATUSCLR register */
...
#define USB_HOST_PSTATUSCLR_BK1RDY(value)     (USB_HOST_PSTATUSCLR_BK1RDY_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSCLR_BK1RDY_Pos)) /* Assignment of value for BK1RDY in the USB_HOST_PSTATUSCLR register */
...
#define USB_HOST_PSTATUSSET_DTGL(value)       (USB_HOST_PSTATUSSET_DTGL_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSSET_DTGL_Pos)) /* Assignment of value for DTGL in the USB_HOST_PSTATUSSET register */
...
#define USB_HOST_PSTATUSSET_CURBK(value)      (USB_HOST_PSTATUSSET_CURBK_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSSET_CURBK_Pos)) /* Assignment of value for CURBK in the USB_HOST_PSTATUSSET register */
...
#define USB_HOST_PSTATUSSET_PFREEZE(value)    (USB_HOST_PSTATUSSET_PFREEZE_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSSET_PFREEZE_Pos)) /* Assignment of value for PFREEZE in the USB_HOST_PSTATUSSET register */
...
#define USB_HOST_PSTATUSSET_BK0RDY(value)     (USB_HOST_PSTATUSSET_BK0RDY_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSSET_BK0RDY_Pos)) /* Assignment of value for BK0RDY in the USB_HOST_PSTATUSSET register */
...
#define USB_HOST_PSTATUSSET_BK1RDY(value)     (USB_HOST_PSTATUSSET_BK1RDY_Msk & ((uint8_t)(value) << USB_HOST_PSTATUSSET_BK1RDY_Pos)) /* Assignment of value for BK1RDY in the USB_HOST_PSTATUSSET register */
...
#define USB_HOST_PSTATUS_DTGL(value)          (USB_HOST_PSTATUS_DTGL_Msk & ((uint8_t)(value) << USB_HOST_PSTATUS_DTGL_Pos)) /* Assignment of value for DTGL in the USB_HOST_PSTATUS register */
...
#define USB_HOST_PSTATUS_CURBK(value)         (USB_HOST_PSTATUS_CURBK_Msk & ((uint8_t)(value) << USB_HOST_PSTATUS_CURBK_Pos)) /* Assignment of value for CURBK in the USB_HOST_PSTATUS register */
...
#define USB_HOST_PSTATUS_PFREEZE(value)       (USB_HOST_PSTATUS_PFREEZE_Msk & ((uint8_t)(value) << USB_HOST_PSTATUS_PFREEZE_Pos)) /* Assignment of value for PFREEZE in the USB_HOST_PSTATUS register */
...
#define USB_HOST_PSTATUS_BK0RDY(value)        (USB_HOST_PSTATUS_BK0RDY_Msk & ((uint8_t)(value) << USB_HOST_PSTATUS_BK0RDY_Pos)) /* Assignment of value for BK0RDY in the USB_HOST_PSTATUS register */
...
#define USB_HOST_PSTATUS_BK1RDY(value)        (USB_HOST_PSTATUS_BK1RDY_Msk & ((uint8_t)(value) << USB_HOST_PSTATUS_BK1RDY_Pos)) /* Assignment of value for BK1RDY in the USB_HOST_PSTATUS register */
...
#define USB_HOST_PINTFLAG_TRCPT0(value)       (USB_HOST_PINTFLAG_TRCPT0_Msk & ((uint8_t)(value) << USB_HOST_PINTFLAG_TRCPT0_Pos)) /* Assignment of value for TRCPT0 in the USB_HOST_PINTFLAG register */
...
#define USB_HOST_PINTFLAG_TRCPT1(value)       (USB_HOST_PINTFLAG_TRCPT1_Msk & ((uint8_t)(value) << USB_HOST_PINTFLAG_TRCPT1_Pos)) /* Assignment of value for TRCPT1 in the USB_HOST_PINTFLAG register */
...
#define USB_HOST_PINTFLAG_TRFAIL(value)       (USB_HOST_PINTFLAG_TRFAIL_Msk & ((uint8_t)(value) << USB_HOST_PINTFLAG_TRFAIL_Pos)) /* Assignment of value for TRFAIL in the USB_HOST_PINTFLAG register */
...
#define USB_HOST_PINTFLAG_PERR(value)         (USB_HOST_PINTFLAG_PERR_Msk & ((uint8_t)(value) << USB_HOST_PINTFLAG_PERR_Pos)) /* Assignment of value for PERR in the USB_HOST_PINTFLAG register */
...
#define USB_HOST_PINTFLAG_TXSTP(value)        (USB_HOST_PINTFLAG_TXSTP_Msk & ((uint8_t)(value) << USB_HOST_PINTFLAG_TXSTP_Pos)) /* Assignment of value for TXSTP in the USB_HOST_PINTFLAG register */
...
#define USB_HOST_PINTFLAG_STALL(value)        (USB_HOST_PINTFLAG_STALL_Msk & ((uint8_t)(value) << USB_HOST_PINTFLAG_STALL_Pos)) /* Assignment of value for STALL in the USB_HOST_PINTFLAG register */
...
#define USB_HOST_PINTFLAG_TRCPT(value)        (USB_HOST_PINTFLAG_TRCPT_Msk & ((uint8_t)(value) << USB_HOST_PINTFLAG_TRCPT_Pos)) 
...
#define USB_HOST_PINTENCLR_TRCPT0(value)      (USB_HOST_PINTENCLR_TRCPT0_Msk & ((uint8_t)(value) << USB_HOST_PINTENCLR_TRCPT0_Pos)) /* Assignment of value for TRCPT0 in the USB_HOST_PINTENCLR register */
...
#define USB_HOST_PINTENCLR_TRCPT1(value)      (USB_HOST_PINTENCLR_TRCPT1_Msk & ((uint8_t)(value) << USB_HOST_PINTENCLR_TRCPT1_Pos)) /* Assignment of value for TRCPT1 in the USB_HOST_PINTENCLR register */
...
#define USB_HOST_PINTENCLR_TRFAIL(value)      (USB_HOST_PINTENCLR_TRFAIL_Msk & ((uint8_t)(value) << USB_HOST_PINTENCLR_TRFAIL_Pos)) /* Assignment of value for TRFAIL in the USB_HOST_PINTENCLR register */
...
#define USB_HOST_PINTENCLR_PERR(value)        (USB_HOST_PINTENCLR_PERR_Msk & ((uint8_t)(value) << USB_HOST_PINTENCLR_PERR_Pos)) /* Assignment of value for PERR in the USB_HOST_PINTENCLR register */
...
#define USB_HOST_PINTENCLR_TXSTP(value)       (USB_HOST_PINTENCLR_TXSTP_Msk & ((uint8_t)(value) << USB_HOST_PINTENCLR_TXSTP_Pos)) /* Assignment of value for TXSTP in the USB_HOST_PINTENCLR register */
...
#define USB_HOST_PINTENCLR_STALL(value)       (USB_HOST_PINTENCLR_STALL_Msk & ((uint8_t)(value) << USB_HOST_PINTENCLR_STALL_Pos)) /* Assignment of value for STALL in the USB_HOST_PINTENCLR register */
...
#define USB_HOST_PINTENCLR_TRCPT(value)       (USB_HOST_PINTENCLR_TRCPT_Msk & ((uint8_t)(value) << USB_HOST_PINTENCLR_TRCPT_Pos)) 
...
#define USB_HOST_PINTENSET_TRCPT0(value)      (USB_HOST_PINTENSET_TRCPT0_Msk & ((uint8_t)(value) << USB_HOST_PINTENSET_TRCPT0_Pos)) /* Assignment of value for TRCPT0 in the USB_HOST_PINTENSET register */
...
#define USB_HOST_PINTENSET_TRCPT1(value)      (USB_HOST_PINTENSET_TRCPT1_Msk & ((uint8_t)(value) << USB_HOST_PINTENSET_TRCPT1_Pos)) /* Assignment of value for TRCPT1 in the USB_HOST_PINTENSET register */
...
#define USB_HOST_PINTENSET_TRFAIL(value)      (USB_HOST_PINTENSET_TRFAIL_Msk & ((uint8_t)(value) << USB_HOST_PINTENSET_TRFAIL_Pos)) /* Assignment of value for TRFAIL in the USB_HOST_PINTENSET register */
...
#define USB_HOST_PINTENSET_PERR(value)        (USB_HOST_PINTENSET_PERR_Msk & ((uint8_t)(value) << USB_HOST_PINTENSET_PERR_Pos)) /* Assignment of value for PERR in the USB_HOST_PINTENSET register */
...
#define USB_HOST_PINTENSET_TXSTP(value)       (USB_HOST_PINTENSET_TXSTP_Msk & ((uint8_t)(value) << USB_HOST_PINTENSET_TXSTP_Pos)) /* Assignment of value for TXSTP in the USB_HOST_PINTENSET register */
...
#define USB_HOST_PINTENSET_STALL(value)       (USB_HOST_PINTENSET_STALL_Msk & ((uint8_t)(value) << USB_HOST_PINTENSET_STALL_Pos)) /* Assignment of value for STALL in the USB_HOST_PINTENSET register */
...
#define USB_HOST_PINTENSET_TRCPT(value)       (USB_HOST_PINTENSET_TRCPT_Msk & ((uint8_t)(value) << USB_HOST_PINTENSET_TRCPT_Pos)) 
...
#define USB_CTRLA_SWRST(value)                (USB_CTRLA_SWRST_Msk & ((uint8_t)(value) << USB_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the USB_CTRLA register */
...
#define USB_CTRLA_ENABLE(value)               (USB_CTRLA_ENABLE_Msk & ((uint8_t)(value) << USB_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the USB_CTRLA register */
...
#define USB_CTRLA_RUNSTDBY(value)             (USB_CTRLA_RUNSTDBY_Msk & ((uint8_t)(value) << USB_CTRLA_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the USB_CTRLA register */
...
#define USB_CTRLA_MODE(value)                 (USB_CTRLA_MODE_Msk & ((uint8_t)(value) << USB_CTRLA_MODE_Pos)) /* Assignment of value for MODE in the USB_CTRLA register */
...
#define USB_SYNCBUSY_SWRST(value)             (USB_SYNCBUSY_SWRST_Msk & ((uint8_t)(value) << USB_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the USB_SYNCBUSY register */
...
#define USB_SYNCBUSY_ENABLE(value)            (USB_SYNCBUSY_ENABLE_Msk & ((uint8_t)(value) << USB_SYNCBUSY_ENABLE_Pos)) /* Assignment of value for ENABLE in the USB_SYNCBUSY register */
...
#define USB_QOSCTRL_CQOS(value)               (USB_QOSCTRL_CQOS_Msk & ((uint8_t)(value) << USB_QOSCTRL_CQOS_Pos)) /* Assignment of value for CQOS in the USB_QOSCTRL register */
...
#define USB_QOSCTRL_DQOS(value)               (USB_QOSCTRL_DQOS_Msk & ((uint8_t)(value) << USB_QOSCTRL_DQOS_Pos)) /* Assignment of value for DQOS in the USB_QOSCTRL register */
...
#define USB_DEVICE_CTRLB_DETACH(value)        (USB_DEVICE_CTRLB_DETACH_Msk & ((uint16_t)(value) << USB_DEVICE_CTRLB_DETACH_Pos)) /* Assignment of value for DETACH in the USB_DEVICE_CTRLB register */
...
#define USB_DEVICE_CTRLB_UPRSM(value)         (USB_DEVICE_CTRLB_UPRSM_Msk & ((uint16_t)(value) << USB_DEVICE_CTRLB_UPRSM_Pos)) /* Assignment of value for UPRSM in the USB_DEVICE_CTRLB register */
...
#define USB_DEVICE_CTRLB_SPDCONF(value)       (USB_DEVICE_CTRLB_SPDCONF_Msk & ((uint16_t)(value) << USB_DEVICE_CTRLB_SPDCONF_Pos)) /* Assignment of value for SPDCONF in the USB_DEVICE_CTRLB register */
...
#define USB_DEVICE_CTRLB_NREPLY(value)        (USB_DEVICE_CTRLB_NREPLY_Msk & ((uint16_t)(value) << USB_DEVICE_CTRLB_NREPLY_Pos)) /* Assignment of value for NREPLY in the USB_DEVICE_CTRLB register */
...
#define USB_DEVICE_CTRLB_OPMODE2(value)       (USB_DEVICE_CTRLB_OPMODE2_Msk & ((uint16_t)(value) << USB_DEVICE_CTRLB_OPMODE2_Pos)) /* Assignment of value for OPMODE2 in the USB_DEVICE_CTRLB register */
...
#define USB_DEVICE_CTRLB_GNAK(value)          (USB_DEVICE_CTRLB_GNAK_Msk & ((uint16_t)(value) << USB_DEVICE_CTRLB_GNAK_Pos)) /* Assignment of value for GNAK in the USB_DEVICE_CTRLB register */
...
#define USB_DEVICE_CTRLB_LPMHDSK(value)       (USB_DEVICE_CTRLB_LPMHDSK_Msk & ((uint16_t)(value) << USB_DEVICE_CTRLB_LPMHDSK_Pos)) /* Assignment of value for LPMHDSK in the USB_DEVICE_CTRLB register */
...
#define USB_DEVICE_CTRLB_Msk                  _UINT16_(0x0F1F)                                     /* (USB_DEVICE_CTRLB) Register Mask  */
...
#define USB_DEVICE_CTRLB_OPMODE(value)        (USB_DEVICE_CTRLB_OPMODE_Msk & ((uint16_t)(value) << USB_DEVICE_CTRLB_OPMODE_Pos)) 
...
#define USB_HOST_CTRLB_RESUME(value)          (USB_HOST_CTRLB_RESUME_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_RESUME_Pos)) /* Assignment of value for RESUME in the USB_HOST_CTRLB register */
...
#define USB_HOST_CTRLB_SPDCONF(value)         (USB_HOST_CTRLB_SPDCONF_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_SPDCONF_Pos)) /* Assignment of value for SPDCONF in the USB_HOST_CTRLB register */
...
#define USB_HOST_CTRLB_AUTORESUME(value)      (USB_HOST_CTRLB_AUTORESUME_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_AUTORESUME_Pos)) /* Assignment of value for AUTORESUME in the USB_HOST_CTRLB register */
...
#define USB_HOST_CTRLB_TSTJ(value)            (USB_HOST_CTRLB_TSTJ_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_TSTJ_Pos)) /* Assignment of value for TSTJ in the USB_HOST_CTRLB register */
...
#define USB_HOST_CTRLB_TSTK(value)            (USB_HOST_CTRLB_TSTK_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_TSTK_Pos)) /* Assignment of value for TSTK in the USB_HOST_CTRLB register */
...
#define USB_HOST_CTRLB_SOFE(value)            (USB_HOST_CTRLB_SOFE_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_SOFE_Pos)) /* Assignment of value for SOFE in the USB_HOST_CTRLB register */
...
#define USB_HOST_CTRLB_BUSRESET(value)        (USB_HOST_CTRLB_BUSRESET_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_BUSRESET_Pos)) /* Assignment of value for BUSRESET in the USB_HOST_CTRLB register */
...
#define USB_HOST_CTRLB_VBUSOK(value)          (USB_HOST_CTRLB_VBUSOK_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_VBUSOK_Pos)) /* Assignment of value for VBUSOK in the USB_HOST_CTRLB register */
...
#define USB_HOST_CTRLB_L1RESUME(value)        (USB_HOST_CTRLB_L1RESUME_Msk & ((uint16_t)(value) << USB_HOST_CTRLB_L1RESUME_Pos)) /* Assignment of value for L1RESUME in the USB_HOST_CTRLB register */
...
#define USB_DEVICE_DADD_DADD(value)           (USB_DEVICE_DADD_DADD_Msk & ((uint8_t)(value) << USB_DEVICE_DADD_DADD_Pos)) /* Assignment of value for DADD in the USB_DEVICE_DADD register */
...
#define USB_DEVICE_DADD_ADDEN(value)          (USB_DEVICE_DADD_ADDEN_Msk & ((uint8_t)(value) << USB_DEVICE_DADD_ADDEN_Pos)) /* Assignment of value for ADDEN in the USB_DEVICE_DADD register */
...
#define USB_HOST_HSOFC_FLENC(value)           (USB_HOST_HSOFC_FLENC_Msk & ((uint8_t)(value) << USB_HOST_HSOFC_FLENC_Pos)) /* Assignment of value for FLENC in the USB_HOST_HSOFC register */
...
#define USB_HOST_HSOFC_FLENCE(value)          (USB_HOST_HSOFC_FLENCE_Msk & ((uint8_t)(value) << USB_HOST_HSOFC_FLENCE_Pos)) /* Assignment of value for FLENCE in the USB_HOST_HSOFC register */
...
#define USB_DEVICE_STATUS_SPEED(value)        (USB_DEVICE_STATUS_SPEED_Msk & ((uint8_t)(value) << USB_DEVICE_STATUS_SPEED_Pos)) /* Assignment of value for SPEED in the USB_DEVICE_STATUS register */
...
#define USB_DEVICE_STATUS_LINESTATE(value)    (USB_DEVICE_STATUS_LINESTATE_Msk & ((uint8_t)(value) << USB_DEVICE_STATUS_LINESTATE_Pos)) /* Assignment of value for LINESTATE in the USB_DEVICE_STATUS register */
...
#define USB_HOST_STATUS_SPEED(value)          (USB_HOST_STATUS_SPEED_Msk & ((uint8_t)(value) << USB_HOST_STATUS_SPEED_Pos)) /* Assignment of value for SPEED in the USB_HOST_STATUS register */
...
#define USB_HOST_STATUS_LINESTATE(value)      (USB_HOST_STATUS_LINESTATE_Msk & ((uint8_t)(value) << USB_HOST_STATUS_LINESTATE_Pos)) /* Assignment of value for LINESTATE in the USB_HOST_STATUS register */
...
#define USB_FSMSTATUS_FSMSTATE(value)         (USB_FSMSTATUS_FSMSTATE_Msk & ((uint8_t)(value) << USB_FSMSTATUS_FSMSTATE_Pos)) /* Assignment of value for FSMSTATE in the USB_FSMSTATUS register */
...
#define USB_DEVICE_FNUM_MFNUM(value)          (USB_DEVICE_FNUM_MFNUM_Msk & ((uint16_t)(value) << USB_DEVICE_FNUM_MFNUM_Pos)) /* Assignment of value for MFNUM in the USB_DEVICE_FNUM register */
...
#define USB_DEVICE_FNUM_FNUM(value)           (USB_DEVICE_FNUM_FNUM_Msk & ((uint16_t)(value) << USB_DEVICE_FNUM_FNUM_Pos)) /* Assignment of value for FNUM in the USB_DEVICE_FNUM register */
...
#define USB_DEVICE_FNUM_FNCERR(value)         (USB_DEVICE_FNUM_FNCERR_Msk & ((uint16_t)(value) << USB_DEVICE_FNUM_FNCERR_Pos)) /* Assignment of value for FNCERR in the USB_DEVICE_FNUM register */
...
#define USB_HOST_FNUM_MFNUM(value)            (USB_HOST_FNUM_MFNUM_Msk & ((uint16_t)(value) << USB_HOST_FNUM_MFNUM_Pos)) /* Assignment of value for MFNUM in the USB_HOST_FNUM register */
...
#define USB_HOST_FNUM_FNUM(value)             (USB_HOST_FNUM_FNUM_Msk & ((uint16_t)(value) << USB_HOST_FNUM_FNUM_Pos)) /* Assignment of value for FNUM in the USB_HOST_FNUM register */
...
#define USB_HOST_FLENHIGH_FLENHIGH(value)     (USB_HOST_FLENHIGH_FLENHIGH_Msk & ((uint8_t)(value) << USB_HOST_FLENHIGH_FLENHIGH_Pos)) /* Assignment of value for FLENHIGH in the USB_HOST_FLENHIGH register */
...
#define USB_DEVICE_INTENCLR_SUSPEND(value)    (USB_DEVICE_INTENCLR_SUSPEND_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_SUSPEND_Pos)) /* Assignment of value for SUSPEND in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_MSOF(value)       (USB_DEVICE_INTENCLR_MSOF_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_MSOF_Pos)) /* Assignment of value for MSOF in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_SOF(value)        (USB_DEVICE_INTENCLR_SOF_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_SOF_Pos)) /* Assignment of value for SOF in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_EORST(value)      (USB_DEVICE_INTENCLR_EORST_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_EORST_Pos)) /* Assignment of value for EORST in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_WAKEUP(value)     (USB_DEVICE_INTENCLR_WAKEUP_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_EORSM(value)      (USB_DEVICE_INTENCLR_EORSM_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_EORSM_Pos)) /* Assignment of value for EORSM in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_UPRSM(value)      (USB_DEVICE_INTENCLR_UPRSM_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_UPRSM_Pos)) /* Assignment of value for UPRSM in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_RAMACER(value)    (USB_DEVICE_INTENCLR_RAMACER_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_RAMACER_Pos)) /* Assignment of value for RAMACER in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_LPMNYET(value)    (USB_DEVICE_INTENCLR_LPMNYET_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_LPMNYET_Pos)) /* Assignment of value for LPMNYET in the USB_DEVICE_INTENCLR register */
...
#define USB_DEVICE_INTENCLR_LPMSUSP(value)    (USB_DEVICE_INTENCLR_LPMSUSP_Msk & ((uint16_t)(value) << USB_DEVICE_INTENCLR_LPMSUSP_Pos)) /* Assignment of value for LPMSUSP in the USB_DEVICE_INTENCLR register */
...
#define USB_HOST_INTENCLR_HSOF(value)         (USB_HOST_INTENCLR_HSOF_Msk & ((uint16_t)(value) << USB_HOST_INTENCLR_HSOF_Pos)) /* Assignment of value for HSOF in the USB_HOST_INTENCLR register */
...
#define USB_HOST_INTENCLR_RST(value)          (USB_HOST_INTENCLR_RST_Msk & ((uint16_t)(value) << USB_HOST_INTENCLR_RST_Pos)) /* Assignment of value for RST in the USB_HOST_INTENCLR register */
...
#define USB_HOST_INTENCLR_WAKEUP(value)       (USB_HOST_INTENCLR_WAKEUP_Msk & ((uint16_t)(value) << USB_HOST_INTENCLR_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USB_HOST_INTENCLR register */
...
#define USB_HOST_INTENCLR_DNRSM(value)        (USB_HOST_INTENCLR_DNRSM_Msk & ((uint16_t)(value) << USB_HOST_INTENCLR_DNRSM_Pos)) /* Assignment of value for DNRSM in the USB_HOST_INTENCLR register */
...
#define USB_HOST_INTENCLR_UPRSM(value)        (USB_HOST_INTENCLR_UPRSM_Msk & ((uint16_t)(value) << USB_HOST_INTENCLR_UPRSM_Pos)) /* Assignment of value for UPRSM in the USB_HOST_INTENCLR register */
...
#define USB_HOST_INTENCLR_RAMACER(value)      (USB_HOST_INTENCLR_RAMACER_Msk & ((uint16_t)(value) << USB_HOST_INTENCLR_RAMACER_Pos)) /* Assignment of value for RAMACER in the USB_HOST_INTENCLR register */
...
#define USB_HOST_INTENCLR_DCONN(value)        (USB_HOST_INTENCLR_DCONN_Msk & ((uint16_t)(value) << USB_HOST_INTENCLR_DCONN_Pos)) /* Assignment of value for DCONN in the USB_HOST_INTENCLR register */
...
#define USB_HOST_INTENCLR_DDISC(value)        (USB_HOST_INTENCLR_DDISC_Msk & ((uint16_t)(value) << USB_HOST_INTENCLR_DDISC_Pos)) /* Assignment of value for DDISC in the USB_HOST_INTENCLR register */
...
#define USB_DEVICE_INTENSET_SUSPEND(value)    (USB_DEVICE_INTENSET_SUSPEND_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_SUSPEND_Pos)) /* Assignment of value for SUSPEND in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_MSOF(value)       (USB_DEVICE_INTENSET_MSOF_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_MSOF_Pos)) /* Assignment of value for MSOF in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_SOF(value)        (USB_DEVICE_INTENSET_SOF_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_SOF_Pos)) /* Assignment of value for SOF in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_EORST(value)      (USB_DEVICE_INTENSET_EORST_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_EORST_Pos)) /* Assignment of value for EORST in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_WAKEUP(value)     (USB_DEVICE_INTENSET_WAKEUP_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_EORSM(value)      (USB_DEVICE_INTENSET_EORSM_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_EORSM_Pos)) /* Assignment of value for EORSM in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_UPRSM(value)      (USB_DEVICE_INTENSET_UPRSM_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_UPRSM_Pos)) /* Assignment of value for UPRSM in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_RAMACER(value)    (USB_DEVICE_INTENSET_RAMACER_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_RAMACER_Pos)) /* Assignment of value for RAMACER in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_LPMNYET(value)    (USB_DEVICE_INTENSET_LPMNYET_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_LPMNYET_Pos)) /* Assignment of value for LPMNYET in the USB_DEVICE_INTENSET register */
...
#define USB_DEVICE_INTENSET_LPMSUSP(value)    (USB_DEVICE_INTENSET_LPMSUSP_Msk & ((uint16_t)(value) << USB_DEVICE_INTENSET_LPMSUSP_Pos)) /* Assignment of value for LPMSUSP in the USB_DEVICE_INTENSET register */
...
#define USB_HOST_INTENSET_HSOF(value)         (USB_HOST_INTENSET_HSOF_Msk & ((uint16_t)(value) << USB_HOST_INTENSET_HSOF_Pos)) /* Assignment of value for HSOF in the USB_HOST_INTENSET register */
...
#define USB_HOST_INTENSET_RST(value)          (USB_HOST_INTENSET_RST_Msk & ((uint16_t)(value) << USB_HOST_INTENSET_RST_Pos)) /* Assignment of value for RST in the USB_HOST_INTENSET register */
...
#define USB_HOST_INTENSET_WAKEUP(value)       (USB_HOST_INTENSET_WAKEUP_Msk & ((uint16_t)(value) << USB_HOST_INTENSET_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USB_HOST_INTENSET register */
...
#define USB_HOST_INTENSET_DNRSM(value)        (USB_HOST_INTENSET_DNRSM_Msk & ((uint16_t)(value) << USB_HOST_INTENSET_DNRSM_Pos)) /* Assignment of value for DNRSM in the USB_HOST_INTENSET register */
...
#define USB_HOST_INTENSET_UPRSM(value)        (USB_HOST_INTENSET_UPRSM_Msk & ((uint16_t)(value) << USB_HOST_INTENSET_UPRSM_Pos)) /* Assignment of value for UPRSM in the USB_HOST_INTENSET register */
...
#define USB_HOST_INTENSET_RAMACER(value)      (USB_HOST_INTENSET_RAMACER_Msk & ((uint16_t)(value) << USB_HOST_INTENSET_RAMACER_Pos)) /* Assignment of value for RAMACER in the USB_HOST_INTENSET register */
...
#define USB_HOST_INTENSET_DCONN(value)        (USB_HOST_INTENSET_DCONN_Msk & ((uint16_t)(value) << USB_HOST_INTENSET_DCONN_Pos)) /* Assignment of value for DCONN in the USB_HOST_INTENSET register */
...
#define USB_HOST_INTENSET_DDISC(value)        (USB_HOST_INTENSET_DDISC_Msk & ((uint16_t)(value) << USB_HOST_INTENSET_DDISC_Pos)) /* Assignment of value for DDISC in the USB_HOST_INTENSET register */
...
#define USB_DEVICE_INTFLAG_SUSPEND(value)     (USB_DEVICE_INTFLAG_SUSPEND_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_SUSPEND_Pos)) /* Assignment of value for SUSPEND in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_MSOF(value)        (USB_DEVICE_INTFLAG_MSOF_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_MSOF_Pos)) /* Assignment of value for MSOF in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_SOF(value)         (USB_DEVICE_INTFLAG_SOF_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_SOF_Pos)) /* Assignment of value for SOF in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_EORST(value)       (USB_DEVICE_INTFLAG_EORST_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_EORST_Pos)) /* Assignment of value for EORST in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_WAKEUP(value)      (USB_DEVICE_INTFLAG_WAKEUP_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_EORSM(value)       (USB_DEVICE_INTFLAG_EORSM_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_EORSM_Pos)) /* Assignment of value for EORSM in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_UPRSM(value)       (USB_DEVICE_INTFLAG_UPRSM_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_UPRSM_Pos)) /* Assignment of value for UPRSM in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_RAMACER(value)     (USB_DEVICE_INTFLAG_RAMACER_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_RAMACER_Pos)) /* Assignment of value for RAMACER in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_LPMNYET(value)     (USB_DEVICE_INTFLAG_LPMNYET_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_LPMNYET_Pos)) /* Assignment of value for LPMNYET in the USB_DEVICE_INTFLAG register */
...
#define USB_DEVICE_INTFLAG_LPMSUSP(value)     (USB_DEVICE_INTFLAG_LPMSUSP_Msk & ((uint16_t)(value) << USB_DEVICE_INTFLAG_LPMSUSP_Pos)) /* Assignment of value for LPMSUSP in the USB_DEVICE_INTFLAG register */
...
#define USB_HOST_INTFLAG_HSOF(value)          (USB_HOST_INTFLAG_HSOF_Msk & ((uint16_t)(value) << USB_HOST_INTFLAG_HSOF_Pos)) /* Assignment of value for HSOF in the USB_HOST_INTFLAG register */
...
#define USB_HOST_INTFLAG_RST(value)           (USB_HOST_INTFLAG_RST_Msk & ((uint16_t)(value) << USB_HOST_INTFLAG_RST_Pos)) /* Assignment of value for RST in the USB_HOST_INTFLAG register */
...
#define USB_HOST_INTFLAG_WAKEUP(value)        (USB_HOST_INTFLAG_WAKEUP_Msk & ((uint16_t)(value) << USB_HOST_INTFLAG_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USB_HOST_INTFLAG register */
...
#define USB_HOST_INTFLAG_DNRSM(value)         (USB_HOST_INTFLAG_DNRSM_Msk & ((uint16_t)(value) << USB_HOST_INTFLAG_DNRSM_Pos)) /* Assignment of value for DNRSM in the USB_HOST_INTFLAG register */
...
#define USB_HOST_INTFLAG_UPRSM(value)         (USB_HOST_INTFLAG_UPRSM_Msk & ((uint16_t)(value) << USB_HOST_INTFLAG_UPRSM_Pos)) /* Assignment of value for UPRSM in the USB_HOST_INTFLAG register */
...
#define USB_HOST_INTFLAG_RAMACER(value)       (USB_HOST_INTFLAG_RAMACER_Msk & ((uint16_t)(value) << USB_HOST_INTFLAG_RAMACER_Pos)) /* Assignment of value for RAMACER in the USB_HOST_INTFLAG register */
...
#define USB_HOST_INTFLAG_DCONN(value)         (USB_HOST_INTFLAG_DCONN_Msk & ((uint16_t)(value) << USB_HOST_INTFLAG_DCONN_Pos)) /* Assignment of value for DCONN in the USB_HOST_INTFLAG register */
...
#define USB_HOST_INTFLAG_DDISC(value)         (USB_HOST_INTFLAG_DDISC_Msk & ((uint16_t)(value) << USB_HOST_INTFLAG_DDISC_Pos)) /* Assignment of value for DDISC in the USB_HOST_INTFLAG register */
...
#define USB_DEVICE_EPINTSMRY_EPINT0(value)    (USB_DEVICE_EPINTSMRY_EPINT0_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT0_Pos)) /* Assignment of value for EPINT0 in the USB_DEVICE_EPINTSMRY register */
...
#define USB_DEVICE_EPINTSMRY_EPINT1(value)    (USB_DEVICE_EPINTSMRY_EPINT1_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT1_Pos)) /* Assignment of value for EPINT1 in the USB_DEVICE_EPINTSMRY register */
...
#define USB_DEVICE_EPINTSMRY_EPINT2(value)    (USB_DEVICE_EPINTSMRY_EPINT2_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT2_Pos)) /* Assignment of value for EPINT2 in the USB_DEVICE_EPINTSMRY register */
...
#define USB_DEVICE_EPINTSMRY_EPINT3(value)    (USB_DEVICE_EPINTSMRY_EPINT3_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT3_Pos)) /* Assignment of value for EPINT3 in the USB_DEVICE_EPINTSMRY register */
...
#define USB_DEVICE_EPINTSMRY_EPINT4(value)    (USB_DEVICE_EPINTSMRY_EPINT4_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT4_Pos)) /* Assignment of value for EPINT4 in the USB_DEVICE_EPINTSMRY register */
...
#define USB_DEVICE_EPINTSMRY_EPINT5(value)    (USB_DEVICE_EPINTSMRY_EPINT5_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT5_Pos)) /* Assignment of value for EPINT5 in the USB_DEVICE_EPINTSMRY register */
...
#define USB_DEVICE_EPINTSMRY_EPINT6(value)    (USB_DEVICE_EPINTSMRY_EPINT6_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT6_Pos)) /* Assignment of value for EPINT6 in the USB_DEVICE_EPINTSMRY register */
...
#define USB_DEVICE_EPINTSMRY_EPINT7(value)    (USB_DEVICE_EPINTSMRY_EPINT7_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT7_Pos)) /* Assignment of value for EPINT7 in the USB_DEVICE_EPINTSMRY register */
...
#define USB_DEVICE_EPINTSMRY_EPINT(value)     (USB_DEVICE_EPINTSMRY_EPINT_Msk & ((uint16_t)(value) << USB_DEVICE_EPINTSMRY_EPINT_Pos)) 
...
#define USB_HOST_PINTSMRY_EPINT0(value)       (USB_HOST_PINTSMRY_EPINT0_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT0_Pos)) /* Assignment of value for EPINT0 in the USB_HOST_PINTSMRY register */
...
#define USB_HOST_PINTSMRY_EPINT1(value)       (USB_HOST_PINTSMRY_EPINT1_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT1_Pos)) /* Assignment of value for EPINT1 in the USB_HOST_PINTSMRY register */
...
#define USB_HOST_PINTSMRY_EPINT2(value)       (USB_HOST_PINTSMRY_EPINT2_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT2_Pos)) /* Assignment of value for EPINT2 in the USB_HOST_PINTSMRY register */
...
#define USB_HOST_PINTSMRY_EPINT3(value)       (USB_HOST_PINTSMRY_EPINT3_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT3_Pos)) /* Assignment of value for EPINT3 in the USB_HOST_PINTSMRY register */
...
#define USB_HOST_PINTSMRY_EPINT4(value)       (USB_HOST_PINTSMRY_EPINT4_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT4_Pos)) /* Assignment of value for EPINT4 in the USB_HOST_PINTSMRY register */
...
#define USB_HOST_PINTSMRY_EPINT5(value)       (USB_HOST_PINTSMRY_EPINT5_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT5_Pos)) /* Assignment of value for EPINT5 in the USB_HOST_PINTSMRY register */
...
#define USB_HOST_PINTSMRY_EPINT6(value)       (USB_HOST_PINTSMRY_EPINT6_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT6_Pos)) /* Assignment of value for EPINT6 in the USB_HOST_PINTSMRY register */
...
#define USB_HOST_PINTSMRY_EPINT7(value)       (USB_HOST_PINTSMRY_EPINT7_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT7_Pos)) /* Assignment of value for EPINT7 in the USB_HOST_PINTSMRY register */
...
#define USB_HOST_PINTSMRY_EPINT(value)        (USB_HOST_PINTSMRY_EPINT_Msk & ((uint16_t)(value) << USB_HOST_PINTSMRY_EPINT_Pos)) 
...
#define USB_DESCADD_DESCADD(value)            (USB_DESCADD_DESCADD_Msk & ((uint32_t)(value) << USB_DESCADD_DESCADD_Pos)) /* Assignment of value for DESCADD in the USB_DESCADD register */
...
#define USB_PADCAL_TRANSP(value)              (USB_PADCAL_TRANSP_Msk & ((uint16_t)(value) << USB_PADCAL_TRANSP_Pos)) /* Assignment of value for TRANSP in the USB_PADCAL register */
...
#define USB_PADCAL_TRANSN(value)              (USB_PADCAL_TRANSN_Msk & ((uint16_t)(value) << USB_PADCAL_TRANSN_Pos)) /* Assignment of value for TRANSN in the USB_PADCAL register */
...
#define USB_PADCAL_TRIM(value)                (USB_PADCAL_TRIM_Msk & ((uint16_t)(value) << USB_PADCAL_TRIM_Pos)) /* Assignment of value for TRIM in the USB_PADCAL register */
