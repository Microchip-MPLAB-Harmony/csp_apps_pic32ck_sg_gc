...
#define RSTC_RCAUSE_POR(value)                (RSTC_RCAUSE_POR_Msk & ((uint16_t)(value) << RSTC_RCAUSE_POR_Pos)) /* Assignment of value for POR in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_PORCORE(value)            (RSTC_RCAUSE_PORCORE_Msk & ((uint16_t)(value) << RSTC_RCAUSE_PORCORE_Pos)) /* Assignment of value for PORCORE in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_BORVDDREG(value)          (RSTC_RCAUSE_BORVDDREG_Msk & ((uint16_t)(value) << RSTC_RCAUSE_BORVDDREG_Pos)) /* Assignment of value for BORVDDREG in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_BORVDDA(value)            (RSTC_RCAUSE_BORVDDA_Msk & ((uint16_t)(value) << RSTC_RCAUSE_BORVDDA_Pos)) /* Assignment of value for BORVDDA in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_BORVDDIO(value)           (RSTC_RCAUSE_BORVDDIO_Msk & ((uint16_t)(value) << RSTC_RCAUSE_BORVDDIO_Pos)) /* Assignment of value for BORVDDIO in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_EXT(value)                (RSTC_RCAUSE_EXT_Msk & ((uint16_t)(value) << RSTC_RCAUSE_EXT_Pos)) /* Assignment of value for EXT in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_WDT(value)                (RSTC_RCAUSE_WDT_Msk & ((uint16_t)(value) << RSTC_RCAUSE_WDT_Pos)) /* Assignment of value for WDT in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_SYST(value)               (RSTC_RCAUSE_SYST_Msk & ((uint16_t)(value) << RSTC_RCAUSE_SYST_Pos)) /* Assignment of value for SYST in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_BACKUP(value)             (RSTC_RCAUSE_BACKUP_Msk & ((uint16_t)(value) << RSTC_RCAUSE_BACKUP_Pos)) /* Assignment of value for BACKUP in the RSTC_RCAUSE register */
...
#define RSTC_RCAUSE_LOCKUP(value)             (RSTC_RCAUSE_LOCKUP_Msk & ((uint16_t)(value) << RSTC_RCAUSE_LOCKUP_Pos)) /* Assignment of value for LOCKUP in the RSTC_RCAUSE register */
...
#define RSTC_BKUPEXIT_RTC(value)              (RSTC_BKUPEXIT_RTC_Msk & ((uint8_t)(value) << RSTC_BKUPEXIT_RTC_Pos)) /* Assignment of value for RTC in the RSTC_BKUPEXIT register */
...
#define RSTC_BKUPEXIT_HIB0(value)             (RSTC_BKUPEXIT_HIB0_Msk & ((uint8_t)(value) << RSTC_BKUPEXIT_HIB0_Pos)) /* Assignment of value for HIB0 in the RSTC_BKUPEXIT register */
...
#define RSTC_BKUPEXIT_HIB(value)              (RSTC_BKUPEXIT_HIB_Msk & ((uint8_t)(value) << RSTC_BKUPEXIT_HIB_Pos)) 
...
#define RSTC_DBGCTRL_LCKUPDIS(value)          (RSTC_DBGCTRL_LCKUPDIS_Msk & ((uint32_t)(value) << RSTC_DBGCTRL_LCKUPDIS_Pos)) /* Assignment of value for LCKUPDIS in the RSTC_DBGCTRL register */
