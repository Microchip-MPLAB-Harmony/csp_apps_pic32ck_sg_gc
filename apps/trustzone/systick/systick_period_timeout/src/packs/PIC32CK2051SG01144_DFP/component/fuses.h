...
#define FUSES_BLDRCFG_PFM_BCRP(value)         (FUSES_BLDRCFG_PFM_BCRP_Msk & ((uint32_t)(value) << FUSES_BLDRCFG_PFM_BCRP_Pos)) /* Assignment of value for PFM_BCRP in the FUSES_BLDRCFG register */
...
#define FUSES_BLDRCFG_PFM_BCWP(value)         (FUSES_BLDRCFG_PFM_BCWP_Msk & ((uint32_t)(value) << FUSES_BLDRCFG_PFM_BCWP_Pos)) /* Assignment of value for PFM_BCWP in the FUSES_BLDRCFG register */
...
#define FUSES_BLDRCFG_IDAU_BNSC(value)        (FUSES_BLDRCFG_IDAU_BNSC_Msk & ((uint32_t)(value) << FUSES_BLDRCFG_IDAU_BNSC_Pos)) /* Assignment of value for IDAU_BNSC in the FUSES_BLDRCFG register */
...
#define FUSES_BLDRCFG_BROM_EN_BFMCHK(value)   (FUSES_BLDRCFG_BROM_EN_BFMCHK_Msk & ((uint32_t)(value) << FUSES_BLDRCFG_BROM_EN_BFMCHK_Pos)) /* Assignment of value for BROM_EN_BFMCHK in the FUSES_BLDRCFG register */
...
#define FUSES_BLDRCFG_BROM_EN_PLL(value)      (FUSES_BLDRCFG_BROM_EN_PLL_Msk & ((uint32_t)(value) << FUSES_BLDRCFG_BROM_EN_PLL_Pos)) /* Assignment of value for BROM_EN_PLL in the FUSES_BLDRCFG register */
...
#define FUSES_BLDRCFG_BROM_EN_DALUN(value)    (FUSES_BLDRCFG_BROM_EN_DALUN_Msk & ((uint32_t)(value) << FUSES_BLDRCFG_BROM_EN_DALUN_Pos)) /* Assignment of value for BROM_EN_DALUN in the FUSES_BLDRCFG register */
...
#define FUSES_BLDRCFG_BROM_EN_RWLOCKS(value)  (FUSES_BLDRCFG_BROM_EN_RWLOCKS_Msk & ((uint32_t)(value) << FUSES_BLDRCFG_BROM_EN_RWLOCKS_Pos)) /* Assignment of value for BROM_EN_RWLOCKS in the FUSES_BLDRCFG register */
...
#define FUSES_BROM_BSEQ_SEQNUM(value)         (FUSES_BROM_BSEQ_SEQNUM_Msk & ((uint32_t)(value) << FUSES_BROM_BSEQ_SEQNUM_Pos)) /* Assignment of value for SEQNUM in the FUSES_BROM_BSEQ register */
#define FUSES_BROM_BSEQ_SEQBAR_Pos            _UINT32_(16)                                         /* (FUSES_BROM_BSEQ) Sequence Number Bar (Negated) Position */
#define FUSES_BROM_BSEQ_SEQBAR_Msk            (_UINT32_(0xFFFF) << FUSES_BROM_BSEQ_SEQBAR_Pos)     /* (FUSES_BROM_BSEQ) Sequence Number Bar (Negated) Mask */
#define FUSES_BROM_BSEQ_SEQBAR(value)         (FUSES_BROM_BSEQ_SEQBAR_Msk & ((uint32_t)(value) << FUSES_BROM_BSEQ_SEQBAR_Pos)) /* Assignment of value for SEQBAR in the FUSES_BROM_BSEQ register */
...
#define FUSES_DAL_CPU0(value)                 (FUSES_DAL_CPU0_Msk & ((uint32_t)(value) << FUSES_DAL_CPU0_Pos)) /* Assignment of value for CPU0 in the FUSES_DAL register */
...
#define FUSES_DAL_CPU1(value)                 (FUSES_DAL_CPU1_Msk & ((uint32_t)(value) << FUSES_DAL_CPU1_Pos)) /* Assignment of value for CPU1 in the FUSES_DAL register */
...
#define FUSES_FSEQ_SEQNUM(value)              (FUSES_FSEQ_SEQNUM_Msk & ((uint32_t)(value) << FUSES_FSEQ_SEQNUM_Pos)) /* Assignment of value for SEQNUM in the FUSES_FSEQ register */
#define FUSES_FSEQ_SEQBAR_Pos                 _UINT32_(16)                                         /* (FUSES_FSEQ) Sequence Number Bar (Negated) Position */
#define FUSES_FSEQ_SEQBAR_Msk                 (_UINT32_(0xFFFF) << FUSES_FSEQ_SEQBAR_Pos)          /* (FUSES_FSEQ) Sequence Number Bar (Negated) Mask */
#define FUSES_FSEQ_SEQBAR(value)              (FUSES_FSEQ_SEQBAR_Msk & ((uint32_t)(value) << FUSES_FSEQ_SEQBAR_Pos)) /* Assignment of value for SEQBAR in the FUSES_FSEQ register */
...
#define FUSES_AFSEQ_ASEQNUM(value)            (FUSES_AFSEQ_ASEQNUM_Msk & ((uint32_t)(value) << FUSES_AFSEQ_ASEQNUM_Pos)) /* Assignment of value for ASEQNUM in the FUSES_AFSEQ register */
#define FUSES_AFSEQ_ASEQBAR_Pos               _UINT32_(16)                                         /* (FUSES_AFSEQ) Alternate Sequence Number Bar (Negated) Position */
#define FUSES_AFSEQ_ASEQBAR_Msk               (_UINT32_(0xFFFF) << FUSES_AFSEQ_ASEQBAR_Pos)        /* (FUSES_AFSEQ) Alternate Sequence Number Bar (Negated) Mask */
#define FUSES_AFSEQ_ASEQBAR(value)            (FUSES_AFSEQ_ASEQBAR_Msk & ((uint32_t)(value) << FUSES_AFSEQ_ASEQBAR_Pos)) /* Assignment of value for ASEQBAR in the FUSES_AFSEQ register */
...
#define FUSES_FUCFG0_WDT_ENABLE(value)        (FUSES_FUCFG0_WDT_ENABLE_Msk & ((uint32_t)(value) << FUSES_FUCFG0_WDT_ENABLE_Pos)) /* Assignment of value for WDT_ENABLE in the FUSES_FUCFG0 register */
...
#define FUSES_FUCFG0_WDT_WEN(value)           (FUSES_FUCFG0_WDT_WEN_Msk & ((uint32_t)(value) << FUSES_FUCFG0_WDT_WEN_Pos)) /* Assignment of value for WDT_WEN in the FUSES_FUCFG0 register */
...
#define FUSES_FUCFG0_WDT_RUNSTDBY(value)      (FUSES_FUCFG0_WDT_RUNSTDBY_Msk & ((uint32_t)(value) << FUSES_FUCFG0_WDT_RUNSTDBY_Pos)) /* Assignment of value for WDT_RUNSTDBY in the FUSES_FUCFG0 register */
...
#define FUSES_FUCFG0_WDT_ALWAYSON(value)      (FUSES_FUCFG0_WDT_ALWAYSON_Msk & ((uint32_t)(value) << FUSES_FUCFG0_WDT_ALWAYSON_Pos)) /* Assignment of value for WDT_ALWAYSON in the FUSES_FUCFG0 register */
...
#define FUSES_FUCFG0_WDT_PER(value)           (FUSES_FUCFG0_WDT_PER_Msk & ((uint32_t)(value) << FUSES_FUCFG0_WDT_PER_Pos)) /* Assignment of value for WDT_PER in the FUSES_FUCFG0 register */
...
#define FUSES_FUCFG0_WDT_WINDOW(value)        (FUSES_FUCFG0_WDT_WINDOW_Msk & ((uint32_t)(value) << FUSES_FUCFG0_WDT_WINDOW_Pos)) /* Assignment of value for WDT_WINDOW in the FUSES_FUCFG0 register */
...
#define FUSES_FUCFG0_WDT_EWOFFSET(value)      (FUSES_FUCFG0_WDT_EWOFFSET_Msk & ((uint32_t)(value) << FUSES_FUCFG0_WDT_EWOFFSET_Pos)) /* Assignment of value for WDT_EWOFFSET in the FUSES_FUCFG0 register */
...
#define FUSES_FUCFG2_BRCFGUDSSMOR_BOR_HYST(value) (FUSES_FUCFG2_BRCFGUDSSMOR_BOR_HYST_Msk & ((uint32_t)(value) << FUSES_FUCFG2_BRCFGUDSSMOR_BOR_HYST_Pos)) /* Assignment of value for BRCFGUDSSMOR_BOR_HYST in the FUSES_FUCFG2 register */
...
#define FUSES_FUCFG2_BRCFGUDSSMOR_BOR_TRIP(value) (FUSES_FUCFG2_BRCFGUDSSMOR_BOR_TRIP_Msk & ((uint32_t)(value) << FUSES_FUCFG2_BRCFGUDSSMOR_BOR_TRIP_Pos)) /* Assignment of value for BRCFGUDSSMOR_BOR_TRIP in the FUSES_FUCFG2 register */
...
#define FUSES_FUCFG3_HYST_BOR_VDDIO(value)    (FUSES_FUCFG3_HYST_BOR_VDDIO_Msk & ((uint32_t)(value) << FUSES_FUCFG3_HYST_BOR_VDDIO_Pos)) /* Assignment of value for HYST_BOR_VDDIO in the FUSES_FUCFG3 register */
...
#define FUSES_FUCFG3_BOR_TRIP_VDDIO(value)    (FUSES_FUCFG3_BOR_TRIP_VDDIO_Msk & ((uint32_t)(value) << FUSES_FUCFG3_BOR_TRIP_VDDIO_Pos)) /* Assignment of value for BOR_TRIP_VDDIO in the FUSES_FUCFG3 register */
...
#define FUSES_FUCFG3_HYST_BOR_VDDA(value)     (FUSES_FUCFG3_HYST_BOR_VDDA_Msk & ((uint32_t)(value) << FUSES_FUCFG3_HYST_BOR_VDDA_Pos)) /* Assignment of value for HYST_BOR_VDDA in the FUSES_FUCFG3 register */
...
#define FUSES_FUCFG3_BOR_TRIP_VDDA(value)     (FUSES_FUCFG3_BOR_TRIP_VDDA_Msk & ((uint32_t)(value) << FUSES_FUCFG3_BOR_TRIP_VDDA_Pos)) /* Assignment of value for BOR_TRIP_VDDA in the FUSES_FUCFG3 register */
...
#define FUSES_FUCFG3_HYST_BOR_VDDREG(value)   (FUSES_FUCFG3_HYST_BOR_VDDREG_Msk & ((uint32_t)(value) << FUSES_FUCFG3_HYST_BOR_VDDREG_Pos)) /* Assignment of value for HYST_BOR_VDDREG in the FUSES_FUCFG3 register */
...
#define FUSES_FUCFG5_UCP0(value)              (FUSES_FUCFG5_UCP0_Msk & ((uint32_t)(value) << FUSES_FUCFG5_UCP0_Pos)) /* Assignment of value for UCP0 in the FUSES_FUCFG5 register */
...
#define FUSES_FUCFG5_UCP1(value)              (FUSES_FUCFG5_UCP1_Msk & ((uint32_t)(value) << FUSES_FUCFG5_UCP1_Pos)) /* Assignment of value for UCP1 in the FUSES_FUCFG5 register */
...
#define FUSES_FUCFG6_PFM_ECCCTL(value)        (FUSES_FUCFG6_PFM_ECCCTL_Msk & ((uint32_t)(value) << FUSES_FUCFG6_PFM_ECCCTL_Pos)) /* Assignment of value for PFM_ECCCTL in the FUSES_FUCFG6 register */
...
#define FUSES_FUCFG6_PFM_ECCUNLCK(value)      (FUSES_FUCFG6_PFM_ECCUNLCK_Msk & ((uint32_t)(value) << FUSES_FUCFG6_PFM_ECCUNLCK_Pos)) /* Assignment of value for PFM_ECCUNLCK in the FUSES_FUCFG6 register */
...
#define FUSES_FUCFG6_PFM_SECCNT(value)        (FUSES_FUCFG6_PFM_SECCNT_Msk & ((uint32_t)(value) << FUSES_FUCFG6_PFM_SECCNT_Pos)) /* Assignment of value for PFM_SECCNT in the FUSES_FUCFG6 register */
...
#define FUSES_FUCFG7_PFM_TEMP(value)          (FUSES_FUCFG7_PFM_TEMP_Msk & ((uint32_t)(value) << FUSES_FUCFG7_PFM_TEMP_Pos)) /* Assignment of value for PFM_TEMP in the FUSES_FUCFG7 register */
...
#define FUSES_FUCFG8_PFM_UC1WP(value)         (FUSES_FUCFG8_PFM_UC1WP_Msk & ((uint32_t)(value) << FUSES_FUCFG8_PFM_UC1WP_Pos)) /* Assignment of value for PFM_UC1WP in the FUSES_FUCFG8 register */
...
#define FUSES_FUCFG8_PFM_UC2WP(value)         (FUSES_FUCFG8_PFM_UC2WP_Msk & ((uint32_t)(value) << FUSES_FUCFG8_PFM_UC2WP_Pos)) /* Assignment of value for PFM_UC2WP in the FUSES_FUCFG8 register */
...
#define FUSES_FUCFG8_PFM_UC1WPLOCK(value)     (FUSES_FUCFG8_PFM_UC1WPLOCK_Msk & ((uint32_t)(value) << FUSES_FUCFG8_PFM_UC1WPLOCK_Pos)) /* Assignment of value for PFM_UC1WPLOCK in the FUSES_FUCFG8 register */
...
#define FUSES_FUCFG8_PFM_UC2WPLOCK(value)     (FUSES_FUCFG8_PFM_UC2WPLOCK_Msk & ((uint32_t)(value) << FUSES_FUCFG8_PFM_UC2WPLOCK_Pos)) /* Assignment of value for PFM_UC2WPLOCK in the FUSES_FUCFG8 register */
...
#define FUSES_FUCFG10_NONSECA_PM(value)       (FUSES_FUCFG10_NONSECA_PM_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_PM_Pos)) /* Assignment of value for NONSECA_PM in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_SUPC(value)     (FUSES_FUCFG10_NONSECA_SUPC_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_SUPC_Pos)) /* Assignment of value for NONSECA_SUPC in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_RSTC(value)     (FUSES_FUCFG10_NONSECA_RSTC_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_RSTC_Pos)) /* Assignment of value for NONSECA_RSTC in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_OSCCTRL(value)  (FUSES_FUCFG10_NONSECA_OSCCTRL_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_OSCCTRL_Pos)) /* Assignment of value for NONSECA_OSCCTRL in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_OSC32KCTRL(value) (FUSES_FUCFG10_NONSECA_OSC32KCTRL_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_OSC32KCTRL_Pos)) /* Assignment of value for NONSECA_OSC32KCTRL in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_GCLK(value)     (FUSES_FUCFG10_NONSECA_GCLK_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_GCLK_Pos)) /* Assignment of value for NONSECA_GCLK in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_MCLK(value)     (FUSES_FUCFG10_NONSECA_MCLK_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_MCLK_Pos)) /* Assignment of value for NONSECA_MCLK in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_FREQM(value)    (FUSES_FUCFG10_NONSECA_FREQM_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_FREQM_Pos)) /* Assignment of value for NONSECA_FREQM in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_WDT(value)      (FUSES_FUCFG10_NONSECA_WDT_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_WDT_Pos)) /* Assignment of value for NONSECA_WDT in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_RTC(value)      (FUSES_FUCFG10_NONSECA_RTC_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_RTC_Pos)) /* Assignment of value for NONSECA_RTC in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_EIC(value)      (FUSES_FUCFG10_NONSECA_EIC_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_EIC_Pos)) /* Assignment of value for NONSECA_EIC in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG10_NONSECA_PAC(value)      (FUSES_FUCFG10_NONSECA_PAC_Msk & ((uint32_t)(value) << FUSES_FUCFG10_NONSECA_PAC_Pos)) /* Assignment of value for NONSECA_PAC in the FUSES_FUCFG10 register */
...
#define FUSES_FUCFG11_NONSECB_PORT(value)     (FUSES_FUCFG11_NONSECB_PORT_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_PORT_Pos)) /* Assignment of value for NONSECB_PORT in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_DMA0(value)     (FUSES_FUCFG11_NONSECB_DMA0_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_DMA0_Pos)) /* Assignment of value for NONSECB_DMA0 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_DMA1(value)     (FUSES_FUCFG11_NONSECB_DMA1_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_DMA1_Pos)) /* Assignment of value for NONSECB_DMA1 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_HMATRIX(value)  (FUSES_FUCFG11_NONSECB_HMATRIX_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_HMATRIX_Pos)) /* Assignment of value for NONSECB_HMATRIX in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_CMCC(value)     (FUSES_FUCFG11_NONSECB_CMCC_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_CMCC_Pos)) /* Assignment of value for NONSECB_CMCC in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_PRM(value)      (FUSES_FUCFG11_NONSECB_PRM_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_PRM_Pos)) /* Assignment of value for NONSECB_PRM in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_EVSYS(value)    (FUSES_FUCFG11_NONSECB_EVSYS_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_EVSYS_Pos)) /* Assignment of value for NONSECB_EVSYS in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_SERCOM0(value)  (FUSES_FUCFG11_NONSECB_SERCOM0_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_SERCOM0_Pos)) /* Assignment of value for NONSECB_SERCOM0 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_SERCOM1(value)  (FUSES_FUCFG11_NONSECB_SERCOM1_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_SERCOM1_Pos)) /* Assignment of value for NONSECB_SERCOM1 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_SERCOM2(value)  (FUSES_FUCFG11_NONSECB_SERCOM2_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_SERCOM2_Pos)) /* Assignment of value for NONSECB_SERCOM2 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_SERCOM3(value)  (FUSES_FUCFG11_NONSECB_SERCOM3_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_SERCOM3_Pos)) /* Assignment of value for NONSECB_SERCOM3 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_TCC0(value)     (FUSES_FUCFG11_NONSECB_TCC0_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_TCC0_Pos)) /* Assignment of value for NONSECB_TCC0 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_TCC1(value)     (FUSES_FUCFG11_NONSECB_TCC1_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_TCC1_Pos)) /* Assignment of value for NONSECB_TCC1 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_TCC2(value)     (FUSES_FUCFG11_NONSECB_TCC2_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_TCC2_Pos)) /* Assignment of value for NONSECB_TCC2 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_TCC3(value)     (FUSES_FUCFG11_NONSECB_TCC3_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_TCC3_Pos)) /* Assignment of value for NONSECB_TCC3 in the FUSES_FUCFG11 register */
...
#define FUSES_FUCFG11_NONSECB_DMA(value)      (FUSES_FUCFG11_NONSECB_DMA_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_DMA_Pos)) 
...
#define FUSES_FUCFG11_NONSECB_SERCOM(value)   (FUSES_FUCFG11_NONSECB_SERCOM_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_SERCOM_Pos)) 
...
#define FUSES_FUCFG11_NONSECB_TCC(value)      (FUSES_FUCFG11_NONSECB_TCC_Msk & ((uint32_t)(value) << FUSES_FUCFG11_NONSECB_TCC_Pos)) 
...
#define FUSES_FUCFG12_NONSECC_SERCOM4(value)  (FUSES_FUCFG12_NONSECC_SERCOM4_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SERCOM4_Pos)) /* Assignment of value for NONSECC_SERCOM4 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_SERCOM5(value)  (FUSES_FUCFG12_NONSECC_SERCOM5_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SERCOM5_Pos)) /* Assignment of value for NONSECC_SERCOM5 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_SERCOM6(value)  (FUSES_FUCFG12_NONSECC_SERCOM6_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SERCOM6_Pos)) /* Assignment of value for NONSECC_SERCOM6 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_SERCOM7(value)  (FUSES_FUCFG12_NONSECC_SERCOM7_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SERCOM7_Pos)) /* Assignment of value for NONSECC_SERCOM7 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_TCC4(value)     (FUSES_FUCFG12_NONSECC_TCC4_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_TCC4_Pos)) /* Assignment of value for NONSECC_TCC4 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_TCC5(value)     (FUSES_FUCFG12_NONSECC_TCC5_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_TCC5_Pos)) /* Assignment of value for NONSECC_TCC5 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_TCC6(value)     (FUSES_FUCFG12_NONSECC_TCC6_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_TCC6_Pos)) /* Assignment of value for NONSECC_TCC6 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_TCC7(value)     (FUSES_FUCFG12_NONSECC_TCC7_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_TCC7_Pos)) /* Assignment of value for NONSECC_TCC7 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_ADC(value)      (FUSES_FUCFG12_NONSECC_ADC_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_ADC_Pos)) /* Assignment of value for NONSECC_ADC in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_AC(value)       (FUSES_FUCFG12_NONSECC_AC_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_AC_Pos)) /* Assignment of value for NONSECC_AC in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_PTC(value)      (FUSES_FUCFG12_NONSECC_PTC_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_PTC_Pos)) /* Assignment of value for NONSECC_PTC in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_SPI_IXS(value)  (FUSES_FUCFG12_NONSECC_SPI_IXS_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SPI_IXS_Pos)) /* Assignment of value for NONSECC_SPI_IXS in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_PCC(value)      (FUSES_FUCFG12_NONSECC_PCC_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_PCC_Pos)) /* Assignment of value for NONSECC_PCC in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_CCL(value)      (FUSES_FUCFG12_NONSECC_CCL_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_CCL_Pos)) /* Assignment of value for NONSECC_CCL in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_PDEC(value)     (FUSES_FUCFG12_NONSECC_PDEC_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_PDEC_Pos)) /* Assignment of value for NONSECC_PDEC in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_CAN0(value)     (FUSES_FUCFG12_NONSECC_CAN0_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_CAN0_Pos)) /* Assignment of value for NONSECC_CAN0 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_CAN1(value)     (FUSES_FUCFG12_NONSECC_CAN1_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_CAN1_Pos)) /* Assignment of value for NONSECC_CAN1 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_ETH(value)      (FUSES_FUCFG12_NONSECC_ETH_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_ETH_Pos)) /* Assignment of value for NONSECC_ETH in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_TRNG(value)     (FUSES_FUCFG12_NONSECC_TRNG_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_TRNG_Pos)) /* Assignment of value for NONSECC_TRNG in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_SDMMC0(value)   (FUSES_FUCFG12_NONSECC_SDMMC0_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SDMMC0_Pos)) /* Assignment of value for NONSECC_SDMMC0 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_SDMMC1(value)   (FUSES_FUCFG12_NONSECC_SDMMC1_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SDMMC1_Pos)) /* Assignment of value for NONSECC_SDMMC1 in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_USB(value)      (FUSES_FUCFG12_NONSECC_USB_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_USB_Pos)) /* Assignment of value for NONSECC_USB in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_EBI(value)      (FUSES_FUCFG12_NONSECC_EBI_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_EBI_Pos)) /* Assignment of value for NONSECC_EBI in the FUSES_FUCFG12 register */
...
#define FUSES_FUCFG12_NONSECC_SERCOM(value)   (FUSES_FUCFG12_NONSECC_SERCOM_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SERCOM_Pos)) 
...
#define FUSES_FUCFG12_NONSECC_TCC(value)      (FUSES_FUCFG12_NONSECC_TCC_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_TCC_Pos)) 
...
#define FUSES_FUCFG12_NONSECC_CAN(value)      (FUSES_FUCFG12_NONSECC_CAN_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_CAN_Pos)) 
...
#define FUSES_FUCFG12_NONSECC_SDMMC(value)    (FUSES_FUCFG12_NONSECC_SDMMC_Msk & ((uint32_t)(value) << FUSES_FUCFG12_NONSECC_SDMMC_Pos)) 
...
#define FUSES_FUCFG13_NONSEC_AHB_SQI(value)   (FUSES_FUCFG13_NONSEC_AHB_SQI_Msk & ((uint32_t)(value) << FUSES_FUCFG13_NONSEC_AHB_SQI_Pos)) /* Assignment of value for NONSEC_AHB_SQI in the FUSES_FUCFG13 register */
...
#define FUSES_FUCFG13_NONSEC_AHB_USBHS(value) (FUSES_FUCFG13_NONSEC_AHB_USBHS_Msk & ((uint32_t)(value) << FUSES_FUCFG13_NONSEC_AHB_USBHS_Pos)) /* Assignment of value for NONSEC_AHB_USBHS in the FUSES_FUCFG13 register */
...
#define FUSES_FUCFG13_NONSEC_AHB_HSM(value)   (FUSES_FUCFG13_NONSEC_AHB_HSM_Msk & ((uint32_t)(value) << FUSES_FUCFG13_NONSEC_AHB_HSM_Pos)) /* Assignment of value for NONSEC_AHB_HSM in the FUSES_FUCFG13 register */
...
#define FUSES_FUCFG14_IDAU_ANS(value)         (FUSES_FUCFG14_IDAU_ANS_Msk & ((uint32_t)(value) << FUSES_FUCFG14_IDAU_ANS_Pos)) /* Assignment of value for IDAU_ANS in the FUSES_FUCFG14 register */
...
#define FUSES_FUCFG14_IDAU_ANSC(value)        (FUSES_FUCFG14_IDAU_ANSC_Msk & ((uint32_t)(value) << FUSES_FUCFG14_IDAU_ANSC_Pos)) /* Assignment of value for IDAU_ANSC in the FUSES_FUCFG14 register */
...
#define FUSES_FUCFG15_IDAU_RNS(value)         (FUSES_FUCFG15_IDAU_RNS_Msk & ((uint32_t)(value) << FUSES_FUCFG15_IDAU_RNS_Pos)) /* Assignment of value for IDAU_RNS in the FUSES_FUCFG15 register */
...
#define FUSES_FUCFG16_HSM_PTRMETA0(value)     (FUSES_FUCFG16_HSM_PTRMETA0_Msk & ((uint32_t)(value) << FUSES_FUCFG16_HSM_PTRMETA0_Pos)) /* Assignment of value for HSM_PTRMETA0 in the FUSES_FUCFG16 register */
...
#define FUSES_FUCFG24_HSM_PTRMETA1(value)     (FUSES_FUCFG24_HSM_PTRMETA1_Msk & ((uint32_t)(value) << FUSES_FUCFG24_HSM_PTRMETA1_Pos)) /* Assignment of value for HSM_PTRMETA1 in the FUSES_FUCFG24 register */
...
#define FUSES_FCCFG64_PTCFG0(value)           (FUSES_FCCFG64_PTCFG0_Msk & ((uint32_t)(value) << FUSES_FCCFG64_PTCFG0_Pos)) /* Assignment of value for PTCFG0 in the FUSES_FCCFG64 register */
...
#define FUSES_FCCFG65_ADCFG0(value)           (FUSES_FCCFG65_ADCFG0_Msk & ((uint32_t)(value) << FUSES_FCCFG65_ADCFG0_Pos)) /* Assignment of value for ADCFG0 in the FUSES_FCCFG65 register */
...
#define FUSES_FCCFG66_ACPAIR_SEL(value)       (FUSES_FCCFG66_ACPAIR_SEL_Msk & ((uint32_t)(value) << FUSES_FCCFG66_ACPAIR_SEL_Pos)) /* Assignment of value for ACPAIR_SEL in the FUSES_FCCFG66 register */
...
#define FUSES_FCCFG69_ROOM_ADC_VAL_PTAT(value) (FUSES_FCCFG69_ROOM_ADC_VAL_PTAT_Msk & ((uint32_t)(value) << FUSES_FCCFG69_ROOM_ADC_VAL_PTAT_Pos)) /* Assignment of value for ROOM_ADC_VAL_PTAT in the FUSES_FCCFG69 register */
...
#define FUSES_FCCFG69_ROOM_ADC_VAL_BUFF1V2(value) (FUSES_FCCFG69_ROOM_ADC_VAL_BUFF1V2_Msk & ((uint32_t)(value) << FUSES_FCCFG69_ROOM_ADC_VAL_BUFF1V2_Pos)) /* Assignment of value for ROOM_ADC_VAL_BUFF1V2 in the FUSES_FCCFG69 register */
...
#define FUSES_FCCFG69_ROOM_TEMP_VAL_INT(value) (FUSES_FCCFG69_ROOM_TEMP_VAL_INT_Msk & ((uint32_t)(value) << FUSES_FCCFG69_ROOM_TEMP_VAL_INT_Pos)) /* Assignment of value for ROOM_TEMP_VAL_INT in the FUSES_FCCFG69 register */
...
#define FUSES_FCCFG70_ROOM_TEMP_VAL_DEC(value) (FUSES_FCCFG70_ROOM_TEMP_VAL_DEC_Msk & ((uint32_t)(value) << FUSES_FCCFG70_ROOM_TEMP_VAL_DEC_Pos)) /* Assignment of value for ROOM_TEMP_VAL_DEC in the FUSES_FCCFG70 register */
...
#define FUSES_FCCFG70_ROOM_VREF_VAL(value)    (FUSES_FCCFG70_ROOM_VREF_VAL_Msk & ((uint32_t)(value) << FUSES_FCCFG70_ROOM_VREF_VAL_Pos)) /* Assignment of value for ROOM_VREF_VAL in the FUSES_FCCFG70 register */
...
#define FUSES_FCCFG70_HOT_TEMP_VAL_DEC(value) (FUSES_FCCFG70_HOT_TEMP_VAL_DEC_Msk & ((uint32_t)(value) << FUSES_FCCFG70_HOT_TEMP_VAL_DEC_Pos)) /* Assignment of value for HOT_TEMP_VAL_DEC in the FUSES_FCCFG70 register */
...
#define FUSES_FCCFG70_Reserved(value)         (FUSES_FCCFG70_Reserved_Msk & ((uint32_t)(value) << FUSES_FCCFG70_Reserved_Pos)) /* Assignment of value for Reserved in the FUSES_FCCFG70 register */
...
#define FUSES_FCCFG71_HOT_ADC_VAL_PTAT(value) (FUSES_FCCFG71_HOT_ADC_VAL_PTAT_Msk & ((uint32_t)(value) << FUSES_FCCFG71_HOT_ADC_VAL_PTAT_Pos)) /* Assignment of value for HOT_ADC_VAL_PTAT in the FUSES_FCCFG71 register */
...
#define FUSES_FCCFG71_HOT_ADC_VAL_BUFF1V2(value) (FUSES_FCCFG71_HOT_ADC_VAL_BUFF1V2_Msk & ((uint32_t)(value) << FUSES_FCCFG71_HOT_ADC_VAL_BUFF1V2_Pos)) /* Assignment of value for HOT_ADC_VAL_BUFF1V2 in the FUSES_FCCFG71 register */
...
#define FUSES_FCCFG71_HOT_TEMP_VAL_INT(value) (FUSES_FCCFG71_HOT_TEMP_VAL_INT_Msk & ((uint32_t)(value) << FUSES_FCCFG71_HOT_TEMP_VAL_INT_Pos)) /* Assignment of value for HOT_TEMP_VAL_INT in the FUSES_FCCFG71 register */
...
#define FUSES_FCCFG72_FMAC_31_0(value)        (FUSES_FCCFG72_FMAC_31_0_Msk & ((uint32_t)(value) << FUSES_FCCFG72_FMAC_31_0_Pos)) /* Assignment of value for FMAC_31_0 in the FUSES_FCCFG72 register */
...
#define FUSES_FCCFG73_FMAC_47_32(value)       (FUSES_FCCFG73_FMAC_47_32_Msk & ((uint32_t)(value) << FUSES_FCCFG73_FMAC_47_32_Pos)) /* Assignment of value for FMAC_47_32 in the FUSES_FCCFG73 register */
