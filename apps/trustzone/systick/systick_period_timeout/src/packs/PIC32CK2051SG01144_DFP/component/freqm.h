...
#define FREQM_CTRLA_SWRST(value)              (FREQM_CTRLA_SWRST_Msk & ((uint8_t)(value) << FREQM_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the FREQM_CTRLA register */
...
#define FREQM_CTRLA_ENABLE(value)             (FREQM_CTRLA_ENABLE_Msk & ((uint8_t)(value) << FREQM_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the FREQM_CTRLA register */
...
#define FREQM_CTRLA_FREERUN(value)            (FREQM_CTRLA_FREERUN_Msk & ((uint8_t)(value) << FREQM_CTRLA_FREERUN_Pos)) /* Assignment of value for FREERUN in the FREQM_CTRLA register */
...
#define FREQM_CTRLA_RUNSTDBY(value)           (FREQM_CTRLA_RUNSTDBY_Msk & ((uint8_t)(value) << FREQM_CTRLA_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the FREQM_CTRLA register */
...
#define FREQM_CTRLA_ONDEMAND(value)           (FREQM_CTRLA_ONDEMAND_Msk & ((uint8_t)(value) << FREQM_CTRLA_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the FREQM_CTRLA register */
...
#define FREQM_CTRLB_START(value)              (FREQM_CTRLB_START_Msk & ((uint8_t)(value) << FREQM_CTRLB_START_Pos)) /* Assignment of value for START in the FREQM_CTRLB register */
...
#define FREQM_CFGA_REFNUM(value)              (FREQM_CFGA_REFNUM_Msk & ((uint16_t)(value) << FREQM_CFGA_REFNUM_Pos)) /* Assignment of value for REFNUM in the FREQM_CFGA register */
...
#define FREQM_CFGA_MSRSEL(value)              (FREQM_CFGA_MSRSEL_Msk & ((uint16_t)(value) << FREQM_CFGA_MSRSEL_Pos)) /* Assignment of value for MSRSEL in the FREQM_CFGA register */
...
#define FREQM_CFGA_DIVREF(value)              (FREQM_CFGA_DIVREF_Msk & ((uint16_t)(value) << FREQM_CFGA_DIVREF_Pos)) /* Assignment of value for DIVREF in the FREQM_CFGA register */
...
#define FREQM_CTRLC_WINMODE(value)            (FREQM_CTRLC_WINMODE_Msk & ((uint8_t)(value) << FREQM_CTRLC_WINMODE_Pos)) /* Assignment of value for WINMODE in the FREQM_CTRLC register */
...
#define FREQM_EVCTRL_STARTEI(value)           (FREQM_EVCTRL_STARTEI_Msk & ((uint8_t)(value) << FREQM_EVCTRL_STARTEI_Pos)) /* Assignment of value for STARTEI in the FREQM_EVCTRL register */
...
#define FREQM_EVCTRL_STARTINV(value)          (FREQM_EVCTRL_STARTINV_Msk & ((uint8_t)(value) << FREQM_EVCTRL_STARTINV_Pos)) /* Assignment of value for STARTINV in the FREQM_EVCTRL register */
...
#define FREQM_EVCTRL_DONEEO(value)            (FREQM_EVCTRL_DONEEO_Msk & ((uint8_t)(value) << FREQM_EVCTRL_DONEEO_Pos)) /* Assignment of value for DONEEO in the FREQM_EVCTRL register */
...
#define FREQM_EVCTRL_WINMONEO(value)          (FREQM_EVCTRL_WINMONEO_Msk & ((uint8_t)(value) << FREQM_EVCTRL_WINMONEO_Pos)) /* Assignment of value for WINMONEO in the FREQM_EVCTRL register */
...
#define FREQM_INTENCLR_DONE(value)            (FREQM_INTENCLR_DONE_Msk & ((uint8_t)(value) << FREQM_INTENCLR_DONE_Pos)) /* Assignment of value for DONE in the FREQM_INTENCLR register */
...
#define FREQM_INTENCLR_WINMON(value)          (FREQM_INTENCLR_WINMON_Msk & ((uint8_t)(value) << FREQM_INTENCLR_WINMON_Pos)) /* Assignment of value for WINMON in the FREQM_INTENCLR register */
...
#define FREQM_INTENSET_DONE(value)            (FREQM_INTENSET_DONE_Msk & ((uint8_t)(value) << FREQM_INTENSET_DONE_Pos)) /* Assignment of value for DONE in the FREQM_INTENSET register */
...
#define FREQM_INTENSET_WINMON(value)          (FREQM_INTENSET_WINMON_Msk & ((uint8_t)(value) << FREQM_INTENSET_WINMON_Pos)) /* Assignment of value for WINMON in the FREQM_INTENSET register */
...
#define FREQM_INTFLAG_DONE(value)             (FREQM_INTFLAG_DONE_Msk & ((uint8_t)(value) << FREQM_INTFLAG_DONE_Pos)) /* Assignment of value for DONE in the FREQM_INTFLAG register */
...
#define FREQM_INTFLAG_WINMON(value)           (FREQM_INTFLAG_WINMON_Msk & ((uint8_t)(value) << FREQM_INTFLAG_WINMON_Pos)) /* Assignment of value for WINMON in the FREQM_INTFLAG register */
...
#define FREQM_STATUS_BUSY(value)              (FREQM_STATUS_BUSY_Msk & ((uint8_t)(value) << FREQM_STATUS_BUSY_Pos)) /* Assignment of value for BUSY in the FREQM_STATUS register */
...
#define FREQM_STATUS_OVF(value)               (FREQM_STATUS_OVF_Msk & ((uint8_t)(value) << FREQM_STATUS_OVF_Pos)) /* Assignment of value for OVF in the FREQM_STATUS register */
...
#define FREQM_SYNCBUSY_SWRST(value)           (FREQM_SYNCBUSY_SWRST_Msk & ((uint32_t)(value) << FREQM_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the FREQM_SYNCBUSY register */
...
#define FREQM_SYNCBUSY_ENABLE(value)          (FREQM_SYNCBUSY_ENABLE_Msk & ((uint32_t)(value) << FREQM_SYNCBUSY_ENABLE_Pos)) /* Assignment of value for ENABLE in the FREQM_SYNCBUSY register */
...
#define FREQM_VALUE_VALUE(value)              (FREQM_VALUE_VALUE_Msk & ((uint32_t)(value) << FREQM_VALUE_VALUE_Pos)) /* Assignment of value for VALUE in the FREQM_VALUE register */
...
#define FREQM_WINLT_WINLT(value)              (FREQM_WINLT_WINLT_Msk & ((uint32_t)(value) << FREQM_WINLT_WINLT_Pos)) /* Assignment of value for WINLT in the FREQM_WINLT register */
...
#define FREQM_WINUT_WINUT(value)              (FREQM_WINUT_WINUT_Msk & ((uint32_t)(value) << FREQM_WINUT_WINUT_Pos)) /* Assignment of value for WINUT in the FREQM_WINUT register */
